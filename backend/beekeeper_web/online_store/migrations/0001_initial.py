    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('balance_currency', djmoney.models.fields.CurrencyField(choices=[('EUR', 'Euro'), ('RUB', 'Russian Ruble'), ('USD', 'US Dollar')], default='RUB', editable=False, max_length=3)),
                ('balance', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0'), default_currency='RUB', max_digits=14, verbose_name='Сумма баланса')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tovar_list', models.ManyToManyField(related_name='product_list_transaction', to='online_store.product', verbose_name='Товары заказа')),
