...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<article${ssrRenderAttrs(_attrs)} data-v-79507d1a><div class="order-not-active" data-v-79507d1a><p class="small" data-v-79507d1a>\u0412\u0441\u0435\u0433\u043E \u043D\u0435\u0430\u043A\u0442\u0438\u0432\u043D\u044B\u0445 \u0434\u043E\u0441\u0442\u0430\u0432\u043E\u043A: <span style="${ssrRenderStyle({ "color": "blue" })}" data-v-79507d1a>${ssrInterpolate($data.count_delivery)}</span></p>`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    to: "/admin/delivery/not-active",
    "no-prefetch": ""
  }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<button class="btn" data-v-79507d1a${_scopeId}>\u041F\u043E\u0441\u043C\u043E\u0442\u0440\u0435\u0442\u044C</button>`);
      } else {
        return [
...
const DeliveryNotActive = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender$2], ["__scopeId", "data-v-79507d1a"]]);
const _sfc_main$1 = {
  data() {
    return {
      count_orders: null
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_NuxtLink = __nuxt_component_0$2;
  _push(`<article${ssrRenderAttrs(_attrs)} data-v-43243411><div class="order-not-active" data-v-43243411><p class="small" data-v-43243411>\u0412\u0441\u0435\u0433\u043E \u043D\u0435 \u043E\u0434\u043E\u0431\u0440\u0435\u043D\u043D\u044B\u0445 \u0437\u0430\u043A\u0430\u0437\u043E\u0432: <span style="${ssrRenderStyle({ "color": "blue" })}" data-v-43243411>${ssrInterpolate($data.count_orders)}</span></p>`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    to: "/admin/orders/?status=\u041D\u0435 \u043E\u0434\u043E\u0431\u0440\u0435\u043D\u043D\u044B\u0439",
    "no-prefetch": ""
  }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<button class="btn" data-v-43243411${_scopeId}>\u041F\u043E\u0441\u043C\u043E\u0442\u0440\u0435\u0442\u044C</button>`);
      } else {
        return [
          createVNode("button", { class: "btn" }, "\u041F\u043E\u0441\u043C\u043E\u0442\u0440\u0435\u0442\u044C")
        ];
...
const OrdersMainInfo = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-43243411"]]);
const _sfc_main = {
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<section${ssrRenderAttrs(mergeProps({ class: "grid" }, _attrs))} data-v-1a02961b>`);
  ...
  _push(`<article data-v-1a02961b></article><article data-v-1a02961b></article><article data-v-1a02961b></article><article data-v-1a02961b></article><article data-v-1a02961b></article></section>`);
}
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-1a02961b"]]);

export { index as default };
//# sourceMappingURL=index-6808c5a8.mjs.map
