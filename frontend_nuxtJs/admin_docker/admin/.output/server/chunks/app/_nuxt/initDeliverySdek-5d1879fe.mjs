...
function _sfc_ssrRender$4(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${ssrRenderAttrs(mergeProps({ id: "orderProductList" }, _attrs))} data-v-a59f5cb1><!--[-->`);
  ssrRenderList($props.orderList, (orderItem, index) => {
    _push(`<div class="product_order_info" data-v-a59f5cb1><div class="w-sto flex jus-sp" data-v-a59f5cb1><p data-v-a59f5cb1>${ssrInterpolate(index + 1)}</p> <p data-v-a59f5cb1>${ssrInterpolate(orderItem.price * orderItem.count)} ${ssrInterpolate(orderItem.price_currency)}</p></div><div class="flex" data-v-a59f5cb1><div class="img_order_product_div" data-v-a59f5cb1><img class="img_order_product"${ssrRenderAttr("src", _ctx.$api_root + orderItem.productItem.product.image)} alt="" data-v-a59f5cb1></div><div class="info_order_product_div" data-v-a59f5cb1><div class="name_order_product" data-v-a59f5cb1>${ssrInterpolate(orderItem.productItem.product.name)} ${ssrInterpolate(orderItem.productItem.weight ? "[" + orderItem.productItem.weight.weight + "\u0433\u0440]" : "")}</div><p data-v-a59f5cb1>${ssrInterpolate(orderItem.productItem.price)} ${ssrInterpolate(orderItem.productItem.price_currency)}</p><p data-v-a59f5cb1>${ssrInterpolate(orderItem.count)} \u0448\u0442</p></div></div>`);
...
const OrderItemList = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["ssrRender", _sfc_ssrRender$4], ["__scopeId", "data-v-a59f5cb1"]]);
...
const DeliveryInfoSubmit = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["ssrRender", _sfc_ssrRender$3], ["__scopeId", "data-v-c0ccb281"]]);
...
const OrderStatusClosed = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender$2], ["__scopeId", "data-v-31a9d5b2"]]);
const _sfc_main$1 = {
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(_attrs)} data-v-4b290a6c>`);
  if ($props.delivery.status == "\u041D\u0430 \u043F\u0440\u043E\u0432\u0435\u0440\u043A\u0435" && $props.order.status == "\u041E\u0434\u043E\u0431\u0440\u0435\u043D") {
    _push(`<button class="btn" data-v-4b290a6c> \u041F\u043E\u0434\u0442\u0432\u0435\u0440\u0434\u0438\u0442\u044C \u0434\u043E\u0441\u0442\u0430\u0432\u043A\u0443 </button>`);
  } else {
    _push(`<!---->`);
  }
  if ($props.order.status == "\u041D\u0435 \u043E\u0434\u043E\u0431\u0440\u0435\u043D\u043D\u044B\u0439" && $props.order.payment.status == "succeeded") {
    _push(`<button class="btn" data-v-4b290a6c> \u041F\u043E\u0434\u0442\u0432\u0435\u0440\u0434\u0438\u0442\u044C \u0437\u0430\u043A\u0430\u0437 </button>`);
  ...
  if ($props.delivery.status == "\u041D\u0430 \u043F\u0440\u043E\u0432\u0435\u0440\u043A\u0435" && $props.order.status != "\u041E\u0434\u043E\u0431\u0440\u0435\u043D" && $props.order.payment.status != "succeeded") {
  ...
  if ($props.delivery.status == "\u041E\u0442\u043F\u0440\u0430\u0432\u043B\u0435\u043D") {
    _push(`<button class="btn" data-v-4b290a6c> \u041E\u0442\u0441\u043B\u0435\u0434\u0438\u0442\u044C \u0437\u0430\u043A\u0430\u0437 </button>`);
  } else {
    _push(`<!---->`);
  }
  _push(`</div>`);
...
const OrderSettings = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-4b290a6c"]]);
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${ssrRenderAttrs(_attrs)} data-v-93479e9a><p data-v-93479e9a>\u0421\u0442\u0430\u0442\u0443\u0441 \u043E\u043F\u043B\u0430\u0442\u044B: ${ssrInterpolate($props.payment.status)}</p></div>`);
}
const _sfc_setup = _sfc_main.setup;
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/AdminComp/PaymentInfo.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const PaymentInfo = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-93479e9a"]]);
...
export { OrderItemList as O, PaymentInfo as P, OrderSettings as a, getInfoDelivery as g, initDeviverySdek as i, searchCountOrders as s };
//# sourceMappingURL=initDeliverySdek-5d1879fe.mjs.map
