import { s as searchCountOrders } from './SearchCountOrders-218e6e70.mjs';
...
import { s as searchCountDelivery } from './SearchCountDelivery-568ac941.mjs';
import 'ofetch';
import 'hookable';
import 'unctx';
import 'vue-router';
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<article${ssrRenderAttrs(_attrs)} data-v-1a4b0c11><div class="order-not-active" data-v-1a4b0c11><p class="small" data-v-1a4b0c11>\u0412\u0441\u0435\u0433\u043E \u043D\u0435\u0430\u043A\u0442\u0438\u0432\u043D\u044B\u0445 \u0434\u043E\u0441\u0442\u0430\u0432\u043E\u043A: <span style="${ssrRenderStyle({ "color": "blue" })}" data-v-1a4b0c11>${ssrInterpolate($data.count_delivery)}</span></p>`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    to: "/admin/delivery?filter=status=\u041E\u0442\u043C\u0435\u043D\u0435\u043D",
    "no-prefetch": ""
  }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<button class="btn" data-v-1a4b0c11${_scopeId}>\u041F\u043E\u0441\u043C\u043E\u0442\u0440\u0435\u0442\u044C</button>`);
      } else {
        return [
...
const DeliveryNotActive = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender$2], ["__scopeId", "data-v-1a4b0c11"]]);
const _sfc_main$1 = {
  data() {
    return {
      count_orders: null
...
//# sourceMappingURL=index-bcb5a0f2.mjs.map
