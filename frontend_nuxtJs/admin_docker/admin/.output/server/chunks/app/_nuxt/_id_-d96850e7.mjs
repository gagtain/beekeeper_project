...
import { O as OrderItemList, a as OrderSettings, P as PaymentInfo, s as searchCountOrders } from './PaymentInfo-ed594255.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<section${ssrRenderAttrs(mergeProps({ class: "grid" }, _attrs))} data-v-acfaaf0a><article style="${ssrRenderStyle({ "height": "auto", "min-height": "300px" })}" class="flex" data-v-acfaaf0a>`);
  if ($data.delivery != null) {
    _push(`<div style="${ssrRenderStyle({ "width": "70%" })}" class="delivery_info auto flex jus-sp" data-v-acfaaf0a>`);
  ...
  _push(`</article>`);
  if ($data.delivery != null) {
    _push(`<div style="${ssrRenderStyle({ "grid-column": "1 / -1", "min-height": "300px", "justify-content": "space-between" })}" class="flex" data-v-acfaaf0a><div style="${ssrRenderStyle({ "width": "46%", "padding": "3%", "background": "#fff" })}" data-v-acfaaf0a><p align="center" data-v-acfaaf0a>\u0422\u043E\u0432\u0430\u0440\u044B \u0437\u0430\u043A\u0430\u0437\u0430</p>`);
    ...
    _push(`</div><div style="${ssrRenderStyle({ "width": "46%", "padding": "3%", "background": "#fff" })}" data-v-acfaaf0a>`);
...
const _id_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-acfaaf0a"]]);

export { _id_ as default };
//# sourceMappingURL=_id_-d96850e7.mjs.map
