...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(_attrs)} data-v-2224ff8d>`);
  if ($props.delivery.status == "\u041D\u0430 \u043F\u0440\u043E\u0432\u0435\u0440\u043A\u0435" && $props.order.status == "\u041E\u0434\u043E\u0431\u0440\u0435\u043D") {
    _push(`<button class="btn" data-v-2224ff8d> \u041F\u043E\u0434\u0442\u0432\u0435\u0440\u0434\u0438\u0442\u044C \u0434\u043E\u0441\u0442\u0430\u0432\u043A\u0443 </button>`);
  } else {
    _push(`<!---->`);
  }
  if ($props.order.status == "\u041D\u0435 \u043E\u0434\u043E\u0431\u0440\u0435\u043D\u043D\u044B\u0439" && $props.order.payment == "succeeded") {
    _push(`<button class="btn" data-v-2224ff8d> \u041F\u043E\u0434\u0442\u0432\u0435\u0440\u0434\u0438\u0442\u044C \u0437\u0430\u043A\u0430\u0437 </button>`);
  ...
  if ($props.delivery.status == "\u041E\u0442\u043F\u0440\u0430\u0432\u043B\u0435\u043D") {
    _push(`<button class="btn" data-v-2224ff8d> \u041E\u0442\u0441\u043B\u0435\u0434\u0438\u0442\u044C \u0437\u0430\u043A\u0430\u0437 </button>`);
  } else {
    _push(`<!---->`);
  }
  _push(`</div>`);
...
const OrderSettings = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-2224ff8d"]]);
...
//# sourceMappingURL=PaymentInfo-52cb77cb.mjs.map
