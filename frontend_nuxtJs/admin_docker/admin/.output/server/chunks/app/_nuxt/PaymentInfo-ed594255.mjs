...
function _sfc_ssrRender$4(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${ssrRenderAttrs(mergeProps({ id: "orderProductList" }, _attrs))} data-v-4d21aa8d><!--[-->`);
  ssrRenderList($props.orderList, (orderItem, index) => {
    _push(`<div class="product_order_info" data-v-4d21aa8d><div class="w-sto flex jus-sp" data-v-4d21aa8d><p data-v-4d21aa8d>${ssrInterpolate(index + 1)}</p> <p data-v-4d21aa8d>${ssrInterpolate(orderItem.price * orderItem.count)} ${ssrInterpolate(orderItem.price_currency)}</p></div><div class="flex" data-v-4d21aa8d><div class="img_order_product_div" data-v-4d21aa8d><img class="img_order_product"${ssrRenderAttr("src", _ctx.$api_root + orderItem.productItem.product.image)} alt="" data-v-4d21aa8d></div><div class="info_order_product_div" data-v-4d21aa8d><div class="name_order_product" data-v-4d21aa8d>${ssrInterpolate(orderItem.productItem.product.name)} [${ssrInterpolate(orderItem.productItem.weight.weight)} \u0433\u0440]</div><p data-v-4d21aa8d>${ssrInterpolate(orderItem.productItem.price)} ${ssrInterpolate(orderItem.productItem.price_currency)}</p><p data-v-4d21aa8d>${ssrInterpolate(orderItem.count)} \u0448\u0442</p></div></div>`);
...
const OrderItemList = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["ssrRender", _sfc_ssrRender$4], ["__scopeId", "data-v-4d21aa8d"]]);
...
//# sourceMappingURL=PaymentInfo-ed594255.mjs.map
