...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<section${ssrRenderAttrs(mergeProps({ class: "grid" }, _attrs))} data-v-90a73472><article style="${ssrRenderStyle({ "height": "auto", "min-height": "300px" })}" class="flex" data-v-90a73472>`);
  if ($data.order != null) {
    _push(`<div style="${ssrRenderStyle({ "width": "40%" })}" class="delivery_info auto flex jus-sp" data-v-90a73472>`);
  ...
  _push(`</article>`);
  if ($data.order != null) {
    _push(`<div style="${ssrRenderStyle({ "grid-column": "1 / -1", "min-height": "300px", "justify-content": "space-between" })}" class="flex" data-v-90a73472><div style="${ssrRenderStyle({ "width": "46%", "padding": "3%", "background": "#fff" })}" data-v-90a73472><p align="center" data-v-90a73472>\u0422\u043E\u0432\u0430\u0440\u044B \u0437\u0430\u043A\u0430\u0437\u0430</p>`);
    _push(ssrRenderComponent(_component_order_item_list, {
      orderList: $data.order.product_list_transaction
    }, null, _parent));
    _push(`</div><div style="${ssrRenderStyle({ "width": "46%", "padding": "3%", "background": "#fff" })}" data-v-90a73472>`);
...
const _id_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-90a73472"]]);

export { _id_ as default };
//# sourceMappingURL=_id_-9f41f599.mjs.map
