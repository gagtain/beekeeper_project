import { version, getCurrentInstance, inject, ref, watchEffect, watch, defineComponent, computed, h, resolveComponent, useSSRContext, createApp, reactive, unref, hasInjectionContext, provide, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRef, shallowRef, shallowReactive, isReadonly, mergeProps, withCtx, openBlock, createBlock, defineAsyncComponent, isRef, isShallow, isReactive, toRaw, nextTick, Suspense, Transition } from 'vue';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_id_-5c28aed1.mjs').then((m) => m.default || m)
  },
  {
    name: "admin-delivery",
    path: "/admin/delivery",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-d9f0bd98.mjs').then((m) => m.default || m)
  },
  {
    name: "admin",
    path: "/admin",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-bcb5a0f2.mjs').then((m) => m.default || m)
  },
  {
    name: "admin-news-id",
    path: "/admin/news/:id()",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_id_-a2cfe85d.mjs').then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-3826ea01.mjs').then((m) => m.default || m)
  },
  {
    name: "admin-news",
    path: "/admin/news",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-4094e02a.mjs').then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_id_-e783c4de.mjs').then((m) => m.default || m)
  },
  {
    name: "admin-orders",
    path: "/admin/orders",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-dbc02ece.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
      ...
      if (_push2) {
        ...
        return [
          (openBlock(), createBlock("svg", null, [
            createVNode("use", { "xlink:href": "#trends" })
          ])),
          createVNode("span", null, "Создать новость")
        ];
      }
    }),
    _: 1
...
const _sfc_main$2 = {
  components: { headers, new_header: __nuxt_component_0$1, Page_contend: __nuxt_component_1 }
};
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_new_header = __nuxt_component_0$1;
  const _component_page_contend = __nuxt_component_1;
  _push(`<div${ssrRenderAttrs(_attrs)}>`);
  _push(ssrRenderComponent(_component_new_header, null, null, _parent));
  _push(ssrRenderComponent(_component_page_contend, null, null, _parent));
  _push(`</div>`);
}
