<template>
  <div id="check_form">
    ...
    <delivery_sdek v-if="type == 1" ref="checkout_form_delivery" v-on:onChoise="onChoise($event)"></delivery_sdek>
    <pickup ref="checkout_form_pickup" v-if="type == 2" v-on:onChoise="onChoise($event)"></pickup>
    <delivery_me v-if="type == 3" ref="checkout_form_delivery_me" v-on:onChoise="onChoise($event)"></delivery_me>
  </div>
</template>
...
import delivery_sdek from '../checkout/delivery_sdek.vue';
import pickup from '../checkout/pickup.vue';
import delivery_me from "../checkout/delivery_me.vue";
export default {
