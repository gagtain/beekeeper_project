import { _ as _export_sfc, u as useHead, b as api_root, d as __nuxt_component_0$2 } from '../server.mjs';
import { useSSRContext, resolveComponent, mergeProps, reactive, withCtx, createVNode, createTextVNode } from 'vue';
import { B as BasketInfo, P as ProductListInfo } from './BasketInfo-11720090.mjs';
...
async function getNumber(data) {
  try {
    var response = await axios({
      url: `${api_root}api/v0.1/user/number`,
      method: "get",
      headers: {},
    ...
    get_goods() {
      ...
      this.products.forEach((element) => {
        ...
        for (let i = 1; i <= element.count; i++) {
          console.log("in_list");
          list.push({
            length: element.productItem.dimensions.length,
            width: element.productItem.dimensions.width,
            height: element.productItem.dimensions.height,
            weight: element.productItem.dimensions.weight / 1e3
          });
        }
      });
      console.log(list);
...
const SDEKcart = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["ssrRender", _sfc_ssrRender$6]]);
const _sfc_main$5 = {
  components: { SDEKcart },
  el: "#check_form",
  props: ["type"],
  ...
  methods: {
    ...
    async onChoise(info) {
      ...
      this.delivery_info.delivery_type = "\u0417\u0430\u043A\u0430\u0437 \u0447\u0435\u0440\u0435\u0437 \u0441\u043B\u0443\u0436\u0431\u0443 \u0434\u043E\u0441\u0442\u0430\u0432\u043A\u0438";
...
function _sfc_ssrRender$5(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ id: "check_form" }, _attrs))} data-v-28357489><p class="VAG" align="left" data-v-28357489>\u0414\u043E\u0441\u0442\u0430\u0432\u043A\u0430</p><div class="h_sto" data-v-28357489>`);
  if ($data.delivery_info) {
    _push(`<div data-v-28357489><div class="relative" data-v-28357489><input type="text" disabled${ssrRenderAttr("value", $data.delivery_info.price)} data-v-28357489><span class="floating-label active" data-v-28357489>\u0426\u0435\u043D\u0430</span></div><div class="relative" data-v-28357489><input type="text" disabled${ssrRenderAttr("value", $data.delivery_info.id)} data-v-28357489><span class="floating-label active" data-v-28357489>\u041D\u043E\u043C\u0435\u0440 \u043F\u043E\u0441\u0442\u043C\u0430\u0442\u0430</span></div><div class="relative" data-v-28357489><input type="text" disabled${ssrRenderAttr("value", $data.delivery_info.PVZ.Address)} data-v-28357489><span class="floating-label active" data-v-28357489>\u0410\u0434\u0440\u0435\u0441</span></div><div class="relative" data-v-28357489><input type="text" disabled${ssrRenderAttr("value", $data.delivery_info.term)} data-v-28357489><span class="floating-label active" data-v-28357489>\u041F\u0440\u0438\u043C\u0435\u0440\u043D\u043E\u0435 \u0432\u0440\u0435\u043C\u044F \u0434\u043E\u0441\u0442\u0430\u0432\u043A\u0438</span></div></div>`);
  } else {
    _push(`<!---->`);
  }
  _push(`</div>`);
  _push(ssrRenderComponent(_component_SDEKcart, {
    products: this.$store.getUser.basket,
...
_sfc_main$5.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/checkout/delivery_sdek.vue");
  return _sfc_setup$5 ? _sfc_setup$5(props, ctx) : void 0;
};
const delivery_sdek = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["ssrRender", _sfc_ssrRender$5], ["__scopeId", "data-v-28357489"]]);
const _sfc_main$4 = {
  mounted() {
    let info = {
      id: "-",
...
function _sfc_ssrRender$4(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${ssrRenderAttrs(_attrs)}><p class="VAG" align="left">\u0414\u043E\u0441\u0442\u0430\u0432\u043A\u0430</p><p class="VAG" align="left">\u0410\u0434\u0440\u0435\u0441\u0441: \u0420\u043E\u0441\u0441\u0438\u044F, \u0422\u0430\u043C\u0431\u043E\u0432\u0441\u043A\u0430\u044F \u043E\u0431\u043B \u041F\u043E\u0441\u0435\u043B\u043E\u043A \u041F\u0440\u043E\u0433\u0440\u0435\u0441\u0441 \u0443\u043B</p><iframe src="https://yandex.ru/map-widget/v1/?um=constructor%3Ad6f774796b8ee43fafc04b069f9e5a05a52bd449ab3e11ada5cd6a12821e6305&amp;source=constructor" width="500" height="400" frameborder="0"></iframe></div>`);
}
const _sfc_setup$4 = _sfc_main$4.setup;
_sfc_main$4.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/checkout/pickup.vue");
  return _sfc_setup$4 ? _sfc_setup$4(props, ctx) : void 0;
};
const pickup = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["ssrRender", _sfc_ssrRender$4]]);
async function getStateRegion() {
  try {
    var response = await axios({
      url: `${api_root}api/v0.1/delivery/delivery_state`,
      method: "get",
      headers: {},
      withCredentials: true
    });
...
function _sfc_ssrRender$3(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "m2" }, _attrs))}><p align="left" class="VAG">\u0412\u044B\u0431\u0435\u0440\u0435\u0442\u0435 \u0433\u043E\u0440\u043E\u0434</p><input${ssrRenderAttr("value", $data.select_text)} list="colors-list"><datalist id="colors-list">`);
  if ($data.is_error) {
    _push(`<p>${ssrInterpolate($data.error_message)}</p>`);
  } else {
    _push(`<!---->`);
  }
  _push(`<!--[-->`);
  ssrRenderList($data.list_state_region.data, (el) => {
    _push(`<option class="option"${ssrRenderAttr("value", el.state + " - " + el.region)}></option>`);
  });
  _push(`<!--]--></datalist></div>`);
}
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/checkout/delivery_me.vue");
  return _sfc_setup$3 ? _sfc_setup$3(props, ctx) : void 0;
};
const delivery_me = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["ssrRender", _sfc_ssrRender$3]]);
const _sfc_main$2 = {
  components: { delivery_sdek, pickup, delivery_me },
  el: "#check_form",
  props: ["type"],
  data() {
    return {
  ...
  async mounted() {
    ...
    this.user_default_field_number = r.data.number;
    if (r.status == 400) {
      this.user_default_number = false;
    }
  },
  methods: {
    validate_number() {
    ...
    order_info_select() {
      let data = {};
      if (this.type == 1) {
        data = this.$refs.checkout_form_delivery.order_info_select();
        console.log(data, "d");
      }
      if (this.type == 3) {
        data = this.$refs.checkout_form_delivery_me.order_info_select();
      }
      if (this.type == 2) {
        data = this.$refs.checkout_form_pickup.order_info_select();
      }
      if (!data.status) {
        return data;
      }
      data = this.validate_number();
      return data;
    },
    pickup_type() {
      this.delivery_info = {
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_delivery_sdek = resolveComponent("delivery_sdek");
  const _component_pickup = resolveComponent("pickup");
  const _component_delivery_me = resolveComponent("delivery_me");
  _push(`<div${ssrRenderAttrs(mergeProps({ id: "check_form" }, _attrs))} data-v-a77a79ff><div class="relative m2" data-v-a77a79ff>`);
  if ($data.user_default_number) {
    _push(`<input disabled type="text"${ssrRenderAttr("value", $data.user_default_field_number)} data-v-a77a79ff>`);
  } else {
    _push(`<div data-v-a77a79ff>`);
    if (!$data.user_number_val) {
      _push(`<p style="${ssrRenderStyle({ "color": "brown" })}" data-v-a77a79ff>\u041D\u0435\u0432\u0435\u0440\u043D\u043E \u0443\u043A\u0430\u0437\u0430\u043D \u043D\u043E\u043C\u0435\u0440, \u043F\u0440\u0438\u043C\u0435\u0440: 79111111111</p>`);
    } else {
      _push(`<!---->`);
    }
    _push(`<input type="text"${ssrRenderAttr("value", $data.user_number)} data-v-a77a79ff></div>`);
  }
  _push(`<span class="floating-label active" data-v-a77a79ff>\u041D\u043E\u043C\u0435\u0440 \u0442\u0435\u043B\u0435\u0444\u043E\u043D\u0430</span></div>`);
  if ($data.user_default_number) {
    _push(`<button style="${ssrRenderStyle({ "background": "rgb(76, 175, 80)", "cursor": "pointer", "width": "100%", "border": "medium none", "border-radius": "6px", "font-size": "16px", "padding": "2%" })}" data-v-a77a79ff> \u0418\u0437\u043C\u0435\u043D\u0438\u0442\u044C \u0442\u0435\u043B\u0435\u0444\u043E\u043D </button>`);
  } else {
    _push(`<!---->`);
  }
  if ($props.type == 1) {
    _push(ssrRenderComponent(_component_delivery_sdek, {
      ref: "checkout_form_delivery",
      onOnChoise: ($event) => $options.onChoise($event)
    }, null, _parent));
  } else {
    _push(`<!---->`);
  ...
  if ($props.type == 2) {
    _push(ssrRenderComponent(_component_pickup, {
      ref: "checkout_form_pickup",
      onOnChoise: ($event) => $options.onChoise($event)
    }, null, _parent));
  } else {
    _push(`<!---->`);
  ...
  if ($props.type == 3) {
    _push(ssrRenderComponent(_component_delivery_me, {
      ref: "checkout_form_delivery_me",
      onOnChoise: ($event) => $options.onChoise($event)
    }, null, _parent));
  } else {
    _push(`<!---->`);
...
const Checkouts = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender$2], ["__scopeId", "data-v-a77a79ff"]]);
...
async function addOrder(delivery_price, order_id, number) {
  try {
    var response = await axios({
...
const _sfc_main$1 = {
  ...
  methods: {
    ...
    async submin_order(type2) {
      await this.$emit("forms_validate_met");
      if (this.forms_validate.status) {
        let response_order = await addOrder(this.delivery_info.price, this.order_id, this.forms_validate.number.default ? void 0 : this.forms_validate.number.number);
        this.order_create = response_order.data;
        let created_delivery = await this.create_delivery_lait();
        if (created_delivery) {
          await this.create_payment(type2);
        } else {
    ...
    async create_payment(type2) {
      let response_payment = await createOrderPayment({
        "payment_service": type2 == 1 ? "yookassa" : "offline",
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({
    id: "sub_order",
    class: "w-sto"
  }, _attrs))} data-v-48b145bb>`);
  if ($props.items.length) {
    _push(`<div data-v-48b145bb>`);
    if ($data.type == "offline") {
      _push(ssrRenderComponent(_component_RouterLink, { to: "/checkout" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<button class="w-sto" data-v-48b145bb${_scopeId}><div class="fon_btn" data-v-48b145bb${_scopeId}></div>\u041E\u043F\u043B\u0430\u0442\u0438\u0442\u044C \u043B\u0438\u0447\u043D\u043E</button>`);
          } else {
            return [
              createVNode("button", {
                onClick: ($event) => $options.submin_order(2),
                class: "w-sto"
              }, [
                createVNode("div", { class: "fon_btn" }),
                createTextVNode("\u041E\u043F\u043B\u0430\u0442\u0438\u0442\u044C \u043B\u0438\u0447\u043D\u043E")
              ], 8, ["onClick"])
            ];
          }
        }),
    ...
    _push(ssrRenderComponent(_component_RouterLink, { to: "/checkout" }, {
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`<button style="${ssrRenderStyle($data.type == "offline" ? "margin-top: 0" : "")}" class="w-sto" data-v-48b145bb${_scopeId}><div class="fon_btn" data-v-48b145bb${_scopeId}></div>\u041E\u043F\u043B\u0430\u0442\u0438\u0442\u044C \u043E\u043D\u043B\u0430\u0439\u043D</button>`);
        } else {
          return [
            createVNode("button", {
              style: $data.type == "offline" ? "margin-top: 0" : "",
              onClick: ($event) => $options.submin_order(1),
              class: "w-sto"
            }, [
              createVNode("div", { class: "fon_btn" }),
    ...
    _push(ssrRenderComponent(_component_RouterLink, { to: "/catalog" }, {
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`<button class="w-sto" data-v-48b145bb${_scopeId}><div class="fon_btn" data-v-48b145bb${_scopeId}></div> \u0414\u043E\u0431\u0430\u0432\u0438\u0442\u044C \u0442\u043E\u0432\u0430\u0440</button>`);
        } else {
          return [
...
const Submit_order = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-48b145bb"]]);
async function createCheckout(basket_id_list) {
  try {
    var response = await axios({
      url: `${api_root}api/v0.1/beekeeper_web_api/order/checkout`,
      method: "post",
      headers: {},
      withCredentials: true,
      data: {
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "sot-ob" }, _attrs))} data-v-ece89f2c><div class="wrapper flex" data-v-ece89f2c><div class="user_card flex auto" data-v-ece89f2c><div class="interactiv user_card_div auto" id="checkout" data-v-ece89f2c><div class="w-sto kor" id="kor" data-v-ece89f2c><p class="small-big VAG" data-v-ece89f2c>\u041E\u0444\u043E\u0440\u043C\u043B\u0435\u043D\u0438\u0435</p>`);
  if ($data.order) {
    _push(`<div class="w-sto flex kor_block jus-sp" data-v-ece89f2c><div class="w-sto-1000px checkout" data-v-ece89f2c><div class="select_type_list flex jus-sp" data-v-ece89f2c><button style="${ssrRenderStyle({ "width": "25%" })}" class="${ssrRenderClass([$data.type_checkout == 1 ? "active" : "", "default_btn"])}" data-v-ece89f2c> \u0421\u0414\u042D\u041A </button><button style="${ssrRenderStyle({ "width": "25%" })}" class="${ssrRenderClass([$data.type_checkout == 2 ? "active" : "", "default_btn"])}" data-v-ece89f2c> \u0421\u0430\u043C\u043E\u0432\u044B\u0432\u043E\u0437 </button><button style="${ssrRenderStyle({ "width": "25%" })}" class="${ssrRenderClass([$data.type_checkout == 3 ? "active" : "", "default_btn"])}" data-v-ece89f2c> \u041D\u0430\u0448\u0430 \u0434\u043E\u0441\u0442\u0430\u0432\u043A\u0430 </button></div>`);
    _push(ssrRenderComponent(_component_client_only, null, {}, _parent));
    _push(`<p align="left" class="VAG small" data-v-ece89f2c>\u0422\u043E\u0432\u0430\u0440\u044B</p>`);
    _push(ssrRenderComponent(_component_order_product_list, {
      orderList: $data.order.product_list_transaction
    }, null, _parent));
    _push(`</div><div class="w-sto-1000px register_zakaz" data-v-ece89f2c>`);
    _push(ssrRenderComponent(_component_Submit_order, {
      ref: "sub_order",
      order_id: $data.order.id,
      delivery_info: $data.delivery_info,
      onForms_validate_met: $options.forms_validate_met,
      items: $data.order.product_list_transaction,
    ...
    _push(ssrRenderComponent(_component_ProductListInfo, {
      ...
      ordered: true,
      items: $data.order.product_list_transaction,
      delivery_price: $data.delivery_info.price
    }, null, _parent));
    _push(`</div></div>`);
  } else {
    _push(`<!---->`);
...
const checkout = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-ece89f2c"]]);

export { checkout as default };
//# sourceMappingURL=checkout-afe7c06a.mjs.map
