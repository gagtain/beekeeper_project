import { _ as _export_sfc, u as useHead, g as __nuxt_component_0$1, f as __nuxt_component_0$3, b as api_root } from '../server.mjs';
import { A as AddBasket, F as FavoriteComp } from './FavoriteComp-f62eb513.mjs';
import { C as CatalogProduct, T as TovarMinImageList, R as RatingComp, S as SelectVariantMenu, a as SaleLine, b as SalePrice } from './CatalogProduct-fe210843.mjs';
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(ssrRenderComponent(_component_swiper, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<!--[-->`);
        ssrRenderList($props.add_item_list, (obj) => {
          _push2(ssrRenderComponent(_component_swiper_slide, {
            key: obj.id
          }, {
            default: withCtx((_2, _push3, _parent3, _scopeId2) => {
              if (_push3) {
                _push3(`<div class="h_sto flex" style="${ssrRenderStyle({ "min-height": "400px" })}"${_scopeId2}><p style="${ssrRenderStyle([_ctx.$device.isDesktop ? "width: 50%" : "", { "line-height": "1" }])}" class="${ssrRenderClass([!_ctx.$device.isDesktop ? "small" : "small-big", "small-big VAG auto"])}"${_scopeId2}>${ssrInterpolate(obj.text)}</p></div>`);
              } else {
                return [
                  createVNode("div", {
                    class: "h_sto flex",
        ...
        return [
          (openBlock(true), createBlock(Fragment, null, renderList($props.add_item_list, (obj) => {
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ style: { "padding-top": "50px" } }, _attrs))} data-v-2f84de1d><div class="wrapper" data-v-2f84de1d>`);
  _push(ssrRenderComponent(_component_nuxt_img, {
    format: "webp",
    rel: "preconnect",
  ...
  _push(`<div class="${ssrRenderClass([$data.wrapper_active ? "actives" : "", "absolute main-nak"])}" data-v-2f84de1d></div><div class="main relative" data-v-2f84de1d><div class="interactiv flex" data-v-2f84de1d><div class="main_center auto" data-v-2f84de1d><div class="main_text_div auto" data-v-2f84de1d><p class="main_text" data-v-2f84de1d>${ssrInterpolate($options.get_obj_text("1", "text"))}</p><div class="bt flex m2" data-v-2f84de1d><button style="${ssrRenderStyle(_ctx.$device.isDesktop ? "width: 45%; margin: 0;" : "")}" class="main_bt" data-v-2f84de1d><div class="flex sto" data-v-2f84de1d><p class="main_bt_p" data-v-2f84de1d>\u041F\u043E\u043F\u0440\u043E\u0431\u043E\u0432\u0430\u0442\u044C!</p></div></button>`);
  if (_ctx.$device.isDesktop) {
    _push(`<a href="#advantages" style="${ssrRenderStyle({ "margin": "0", "margin-left": "8px", "width": "45%" })}" class="main_bt" data-v-2f84de1d><div class="flex sto" data-v-2f84de1d><p class="main_bt_p" data-v-2f84de1d>\u041F\u043E\u0441\u043C\u043E\u0442\u0440\u0435\u0442\u044C!</p></div></a>`);
  } else {
    _push(`<!---->`);
  }
  _push(`</div></div>`);
  if (!_ctx.$device.isMobileOrTablet) {
    _push(`<div class="main_img_div" data-v-2f84de1d><img${ssrRenderAttr("src", `${_ctx.$api_root}static/online_store/images/phel.png`)} class="phel" alt="" data-v-2f84de1d><div class="slider-produtos-wrap h_sto" data-v-2f84de1d>`);
    _push(ssrRenderComponent(_component_swiper, {
      slidesPerView: 1,
      spaceBetween: 500,
      autoplay: {
      ...
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`<!--[-->`);
          ssrRenderList($options.get_obj_text("1", "add_item_list"), (obj) => {
            _push2(ssrRenderComponent(_component_swiper_slide, {
              key: obj.id
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<img${ssrRenderAttr("src", `${_ctx.$api_root.slice(0, -1)}${obj.image}`)} class="main_img" width="100%" height="100%" alt="" data-v-2f84de1d${_scopeId2}>`);
                } else {
                  return [
                    createVNode("img", {
                      src: `${_ctx.$api_root.slice(0, -1)}${obj.image}`,
                      class: "main_img",
                      width: "100%",
                      height: "100%",
                      alt: ""
          ...
          return [
            (openBlock(true), createBlock(Fragment, null, renderList($options.get_obj_text("1", "add_item_list"), (obj) => {
              return openBlock(), createBlock(_component_swiper_slide, {
                key: obj.id
              }, {
                default: withCtx(() => [
    ...
    _push(`<div data-v-2f84de1d><div style="${ssrRenderStyle({ "display": "block" })}" class="" data-v-2f84de1d><div class="flex w-sto jus-sp info_kart_div" data-v-2f84de1d><div class="w-sto flex" data-v-2f84de1d><div class="w-sto auto auto" data-v-2f84de1d>`);
    _push(ssrRenderComponent(_component_Advantages_slider, null, null, _parent));
    _push(`</div></div></div></div></div>`);
  }
  _push(`</div></div></div></div><div class="sot" data-v-2f84de1d><div class="interactiv auto" data-v-2f84de1d><div class="flex w-sto text_in_sot" data-v-2f84de1d><p class="big auto main-text" data-v-2f84de1d>\u041F\u043E\u043F\u0443\u043B\u044F\u0440\u043D\u044B\u0435 \u0442\u043E\u0432\u0430\u0440\u044B</p></div><div class="block_info sliders big-block" data-v-2f84de1d><div class="slider-produtos-wrap" data-v-2f84de1d>`);
  if ($data.popular_product != null) {
        ...
        if (_push2) {
          ...
          ssrRenderList($data.popular_product, (pop_product) => {
            _push2(ssrRenderComponent(_component_swiper_slide, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="hex slide auto" data-v-2f84de1d${_scopeId2}>`);
    ...
    _push(`<div class="w-sto h_sto" data-v-2f84de1d>`);
    _push(ssrRenderComponent(_component_LoadingComp, null, null, _parent));
    _push(`</div>`);
  }
  _push(`</div></div>`);
  if (_ctx.$device.isDesktop) {
    _push(`<div class="flex w-sto text_in_sot relative" data-v-2f84de1d><div id="advantages" class="absolute" style="${ssrRenderStyle({ "top": "-80%" })}" data-v-2f84de1d></div><p class="big auto main-text" data-v-2f84de1d>\u041D\u0430\u0448\u0438 \u043F\u0440\u0435\u0438\u043C\u0443\u0449\u0435\u0441\u0442\u0432\u0430</p></div>`);
  } else {
    _push(`<!---->`);
  }
  if (_ctx.$device.isDesktop) {
    _push(`<div style="${ssrRenderStyle({ "display": "block" })}" class="block_info" data-v-2f84de1d><div class="flex w-sto jus-sp info_kart_div" data-v-2f84de1d><div class="w-sto flex" data-v-2f84de1d><div class="w-sto auto auto" data-v-2f84de1d>`);
    _push(ssrRenderComponent(_component_Advantages_slider, {
      add_item_list: $options.get_obj_text("2", "add_item_list")
    }, null, _parent));
  ...
  _push(ssrRenderComponent(_component_to_scroll, { id: "eco" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div style="${ssrRenderStyle({ "display": "block" })}" class="block_info" data-v-2f84de1d${_scopeId}><div class="flex w-sto jus-sp info_kart_div" data-v-2f84de1d${_scopeId}><div class="kart" data-v-2f84de1d${_scopeId}><div class="w-sto h_sto" data-v-2f84de1d${_scopeId}>`);
        _push2(ssrRenderComponent(_component_nuxt_img, {
          loading: "lazy",
          format: "webp",
          style: { "border-radius": "40px" },
          class: "w-sto h_sto",
          src: `${_ctx.$api_root.slice(0, -1)}${$options.get_obj_text("3", "image")}`,
          alt: ""
        }, null, _parent2, _scopeId));
        _push2(`</div></div><div class="dostav_info flex" data-v-2f84de1d${_scopeId}><div class="w-sto auto" data-v-2f84de1d${_scopeId}><p class="small-big VAG" style="${ssrRenderStyle({ "line-height": "1" })}" data-v-2f84de1d${_scopeId}>${ssrInterpolate($options.get_obj_text("3", "title"))}</p><p class="small m2" data-v-2f84de1d${_scopeId}>${ssrInterpolate($options.get_obj_text("3", "text"))}</p></div></div></div></div>`);
      } else {
        return [
          createVNode("div", {
            style: { "display": "block" },
              ...
              createVNode("div", { class: "dostav_info flex" }, [
                createVNode("div", { class: "w-sto auto" }, [
                  createVNode("p", {
                    class: "small-big VAG",
                    style: { "line-height": "1" }
                  }, toDisplayString($options.get_obj_text("3", "title")), 1),
                  createVNode("p", { class: "small m2" }, toDisplayString($options.get_obj_text("3", "text")), 1)
                ])
              ])
            ])
          ])
  ...
  _push(ssrRenderComponent(_component_to_scroll, { id: "news" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="interactiv auto" data-v-2f84de1d${_scopeId}><div class="flex w-sto text_in_sot" data-v-2f84de1d${_scopeId}><p class="big auto main-text" data-v-2f84de1d${_scopeId}>\u041D\u043E\u0432\u043E\u0441\u0442\u0438</p></div><section style="${ssrRenderStyle({ "padding": "5%" })}" class="auto grid" data-v-2f84de1d${_scopeId}><!--[-->`);
        ssrRenderList($data.news, (new_obj) => {
          _push2(`<article class="grid-item" data-v-2f84de1d${_scopeId}><div class="image" data-v-2f84de1d${_scopeId}><img${ssrRenderAttr("src", this.$api_root + new_obj.main_image.slice(1))} data-v-2f84de1d${_scopeId}></div><div class="info" data-v-2f84de1d${_scopeId}>`);
          _push2(ssrRenderComponent(_component_NuxtLink, {
            ...
            default: withCtx((_2, _push3, _parent3, _scopeId2) => {
              if (_push3) {
                _push3(`<h2 class="VAG" data-v-2f84de1d${_scopeId2}>${ssrInterpolate(new_obj.title)}</h2>`);
              } else {
                return [
          ...
          _push2(`<div class="info-text" data-v-2f84de1d${_scopeId}><p data-v-2f84de1d${_scopeId}>${ssrInterpolate(new_obj.main_text.slice(40))}...</p></div><div class="button-wrap" data-v-2f84de1d${_scopeId}>`);
          _push2(ssrRenderComponent(_component_NuxtLink, {
            "no-prefetch": "",
            class: "atuin-btn",
            to: `/news/${new_obj.id}`
        ...
        _push2(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<button style="${ssrRenderStyle({ "background": "rgb(160,166,62)", "cursor": "pointer", "width": "100%", "border": "none", "border-radius": "6px", "padding": "2% 3%" })}" data-v-2f84de1d${_scopeId2}><div class="w-sto h_sto flex" data-v-2f84de1d${_scopeId2}><p class="auto small-big" data-v-2f84de1d${_scopeId2}>\u0412\u0441\u0435 \u043D\u043E\u0432\u043E\u0441\u0442\u0438</p></div></button>`);
            } else {
              return [
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        if (!_ctx.$store.getUser.is_sending) {
          _push2(`<div class="interactiv auto" data-v-2f84de1d${_scopeId}><div class="flex w-sto text_in_sot" data-v-2f84de1d${_scopeId}><p class="big auto main-text" data-v-2f84de1d${_scopeId}>\u0420\u0430\u0441\u0441\u044B\u043B\u043A\u0430</p></div>`);
  ...
  _push(ssrRenderComponent(_component_to_scroll, { id: "ref" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="ref-block w-sto" data-v-2f84de1d${_scopeId}><div class="flex w-sto text_in_sot" data-v-2f84de1d${_scopeId}><p class="big auto main-text" style="${ssrRenderStyle({ "color": "rgb(241, 195, 96)", "text-shadow": "10px 10px 10px black", "padding": "1%" })}" data-v-2f84de1d${_scopeId}>\u041E \u043D\u0430\u0448\u0435\u043C \u0442\u043E\u0432\u0430\u0440\u0435</p></div><div class="interactiv auto h-sto flex" data-v-2f84de1d${_scopeId}><div class="block_info o_product auto" data-v-2f84de1d${_scopeId}><div class="predp" data-v-2f84de1d${_scopeId}><div class="predp-img auto" data-v-2f84de1d${_scopeId}><img width="100%" height="100%"${ssrRenderAttr("src", _ctx.$api_root.slice(0, -1) + $options.get_obj_text("4", "image"))} alt="" data-v-2f84de1d${_scopeId}></div><p class="small-big predp-name" data-v-2f84de1d${_scopeId}>${ssrInterpolate($options.get_obj_text("4", "director"))}</p><p class="small" data-v-2f84de1d${_scopeId}>\u0414\u0438\u0440\u0435\u043A\u0442\u043E\u0440 \u043A\u043E\u043C\u043F\u0430\u043D\u0438\u0438 </p></div><div class="predp-text flex" data-v-2f84de1d${_scopeId}><p class="small-big" data-v-2f84de1d${_scopeId}>${$options.get_obj_text("4", "text")}</p></div></div></div><div class="interactiv" data-v-2f84de1d${_scopeId}></div></div>`);
      } else {
        return [
                ...
                createVNode("div", { class: "predp" }, [
                  createVNode("div", { class: "predp-img auto" }, [
                    createVNode("img", {
                      width: "100%",
                      height: "100%",
                      src: _ctx.$api_root.slice(0, -1) + $options.get_obj_text("4", "image"),
                      alt: ""
                    }, null, 8, ["src"])
                  ]),
                  createVNode("p", { class: "small-big predp-name" }, toDisplayString($options.get_obj_text("4", "director")), 1),
                  createVNode("p", { class: "small" }, "\u0414\u0438\u0440\u0435\u043A\u0442\u043E\u0440 \u043A\u043E\u043C\u043F\u0430\u043D\u0438\u0438 ")
                ]),
                createVNode("div", { class: "predp-text flex" }, [
                  createVNode("p", {
                    class: "small-big",
                    innerHTML: $options.get_obj_text("4", "text")
                  }, null, 8, ["innerHTML"])
                ])
              ])
            ]),
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-2f84de1d"]]);

export { index as default };
//# sourceMappingURL=index-14d4e7e3.mjs.map
