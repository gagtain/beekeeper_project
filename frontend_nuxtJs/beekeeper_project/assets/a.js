...
export default function ISDEKWidjet(params) {
		...
		calculate: function (forse=false) {
			if (this.cityFrom) {
				...
				if (courier_idx !== -1 && pickup_idx !== -1) {
					...
					let mark = Date.now();
					//Р—Р°РјРµРЅР° РєРѕРґР° РіРѕСЂРѕРґР° РґР»СЏ РќРџ "Р‘С‹РєРѕРІРѕ СЃРµР»Рѕ"
					//Р”РѕРїРѕР»РЅРёС‚РµР»СЊРЅС‹Р№ РєРѕРјРјРµРЅС‚Р°СЂРёР№ РІ service.php getCityByName
				...
				if (typeof pvzList === 'object') {
					...
					for (var i in pvzList) {
						...
						pvzList[i].placeMark.events.add(['mouseenter'], function (metka) {
							// РџРµСЂРµРјРµС‰РµРЅРёРµ Рє РїРІР· РІ СЃРїРёСЃРєРµ РїСЂРё РЅР°РІРµРґРµРЅРёРё РЅР° РјР°СЂРєРµСЂ
						...
						// РћС‚РєР»РѕСЋС‡РµРЅРёРµ РїРѕРґСЃРІРµС‡РёРІР°РЅРёСЏ РјР°СЂРєРµСЂР° РЅР° РєР°СЂС‚Рµ РїСЂРё РЅР°РІРµРґРµРЅРёРё РЅР° РїРІР· РёР· СЃРїРёРєР° РЅР° Р±РѕРєРѕРІРѕР№ РїР°РЅРµР»Рё
						// 	.on('mouseenter', {
						// 		id: i,
						// 		ifOn: true,
						// 		link: template.ymaps
