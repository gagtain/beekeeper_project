...
const _routes = [
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/catalog-875586ce.js").then((m) => m.default || m)
  },
  {
    name: "checkout",
    path: "/checkout",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/checkout-f2b657dd.js").then((m) => m.default || m)
  },
  {
    name: "favorite",
    path: "/favorite",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-b627e794.js").then((m) => m.default || m)
  },
  {
    name: "login",
    path: "/login",
