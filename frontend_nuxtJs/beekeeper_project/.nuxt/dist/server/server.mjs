import { reactive, hasInjectionContext, getCurrentInstance, inject, effectScope, ref, markRaw, watch, isRef, isReactive, toRef, toRaw, nextTick, computed, getCurrentScope, onScopeDispose, unref, toRefs, version, watchEffect, onServerPrefetch, defineComponent, h, resolveComponent, isShallow, shallowRef, isReadonly, createElementBlock, mergeProps, useSSRContext, withCtx, createVNode, toDisplayString, createTextVNode, Suspense, Transition, provide, onErrorCaptured, resolveDynamicComponent, defineAsyncComponent, createApp } from "vue";
...
import { ssrRenderAttrs, ssrRenderStyle, ssrRenderAttr, ssrRenderList, ssrInterpolate, ssrRenderSlot, ssrRenderComponent, ssrRenderClass, ssrRenderSuspense, ssrRenderVNode } from "vue/server-renderer";
...
const _routes = [
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/basket-63a1334d.js").then((m) => m.default || m)
  },
  {
    name: "catalog",
    path: "/catalog",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/catalog-89b2f8ed.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/checkout-6c28eff2.js").then((m) => m.default || m)
  },
  {
    name: "favorite",
    path: "/favorite",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/favorite-5fbd1410.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/login-017335ee.js").then((m) => m.default || m)
  },
  {
    name: "news-id",
    path: "/news/:id()",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-c387e6df.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/orders-6847907c.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/profile-c9668d1e.js").then((m) => m.default || m)
  },
  {
    name: "register",
    path: "/register",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/_id_-4f6ee253.js").then((m) => m.default || m)
  }
];
...
const namedMiddleware = {
  "is-auth": () => import("./_nuxt/isAuth-36f42893.js")
};
...
const search_css_vue_type_style_index_1_src_f620389d_scoped_f620389d_lang = "";
...
const Notify_vue_vue_type_style_index_0_lang = "";
const _sfc_main$7 = {
  el: "#notify",
  data() {
    return {
...
const checkbox_scss_vue_type_style_index_0_src_60776801_scoped_60776801_lang = "";
const _sfc_main$6 = {
  props: ["id"],
  data() {
    return { ids: null };
...
const headers_css_vue_type_style_index_0_src_8248a74e_scoped_8248a74e_lang = "";
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-component-8117d286.js").then((r) => r.default || r));
