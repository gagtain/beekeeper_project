...
import { B as BasketInfo, P as ProductListInfo } from "./BasketInfo-3489103b.js";
    ...
    get_goods() {
      ...
      this.products.forEach((element) => {
        list.push({
          ...
          weight: element.productItem.weight.weight / 1e3
        });
      });
      console.log(list);
      return list;
...
const checkbox_scss_vue_type_style_index_0_src_e6ddf9f8_scoped_e6ddf9f8_lang = "";
const Checkout_vue_vue_type_style_index_1_scoped_e6ddf9f8_lang = "";
const Checkout_vue_vue_type_style_index_2_scoped_e6ddf9f8_lang = "";
const _sfc_main$2 = {
  components: { SDEKcart },
  el: "#check_form",
  data() {
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ id: "check_form" }, _attrs))} data-v-e6ddf9f8><p class="VAG" align="left" data-v-e6ddf9f8>Доставка</p><div class="h_sto" data-v-e6ddf9f8>`);
  if ($data.delivery_info) {
    _push(`<div data-v-e6ddf9f8><div class="relative" data-v-e6ddf9f8><input type="text" disabled${ssrRenderAttr("value", $data.delivery_info.price)} data-v-e6ddf9f8><span class="floating-label active" data-v-e6ddf9f8>Цена</span></div><div class="relative" data-v-e6ddf9f8><input type="text" disabled${ssrRenderAttr("value", $data.delivery_info.id)} data-v-e6ddf9f8><span class="floating-label active" data-v-e6ddf9f8>Номер постмата</span></div><div class="relative" data-v-e6ddf9f8><input type="text" disabled${ssrRenderAttr("value", $data.delivery_info.PVZ.Address)} data-v-e6ddf9f8><span class="floating-label active" data-v-e6ddf9f8>Адрес</span></div><div class="relative" data-v-e6ddf9f8><input type="text" disabled${ssrRenderAttr("value", $data.delivery_info.term)} data-v-e6ddf9f8><span class="floating-label active" data-v-e6ddf9f8>Примерное время доставки</span></div></div>`);
  } else {
    _push(`<!---->`);
  }
  _push(`</div>`);
...
const Checkout = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender$2], ["__scopeId", "data-v-e6ddf9f8"]]);
...
const account_css_vue_type_style_index_0_src_000353ed_scoped_000353ed_lang = "";
const _sfc_main$1 = {
  el: "#sub_order",
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({
    id: "sub_order",
    class: "w-sto"
  }, _attrs))} data-v-000353ed>`);
  if ($props.items.length) {
    _push(ssrRenderComponent(_component_RouterLink, { to: "/checkout" }, {
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`<button class="w-sto" data-v-000353ed${_scopeId}><div class="fon_btn" data-v-000353ed${_scopeId}></div>Оплатить онлайн</button>`);
        } else {
          return [
            createVNode("button", {
    ...
    _push(ssrRenderComponent(_component_RouterLink, { to: "/catalog" }, {
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`<button class="w-sto" data-v-000353ed${_scopeId}><div class="fon_btn" data-v-000353ed${_scopeId}></div> Добавить товар</button>`);
        } else {
          return [
...
const Submit_order = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-000353ed"]]);
...
//# sourceMappingURL=checkout-d9301de4.js.map
