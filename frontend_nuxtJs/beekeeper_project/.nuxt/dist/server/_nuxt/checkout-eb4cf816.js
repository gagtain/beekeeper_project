import { defineComponent, ref, createElementBlock, mergeProps, useSSRContext, reactive, resolveComponent, withCtx, createVNode, createTextVNode } from "vue";
import { B as BasketInfo, P as ProductListInfo } from "./BasketInfo-ef2828cd.js";
    ...
    PVZ: {
      ...
      getCityPVZ: function(intCityID) {
        if (DATA.listCityCode.includes(Number(intCityID))) {
          if (DATA.currentCityName === "Р РѕСЃСЃРёСЏ РњРѕСЃРєРІР° РњРѕСЃРєРІР°") {
...
const delivery_sdek_css_vue_type_style_index_0_src_true_lang = "";
const SDEKcart_vue_vue_type_style_index_1_lang = "";
const _sfc_main$3 = {
  el: "#s",
  mounted() {
...
const checkbox_scss_vue_type_style_index_0_src_17aa6c38_scoped_17aa6c38_lang = "";
const Checkout_vue_vue_type_style_index_1_scoped_17aa6c38_lang = "";
const Checkout_vue_vue_type_style_index_2_scoped_17aa6c38_lang = "";
const _sfc_main$2 = {
  components: { SDEKcart },
  el: "#check_form",
  data() {
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ id: "check_form" }, _attrs))} data-v-17aa6c38><p class="VAG" align="left" data-v-17aa6c38>Доставка</p><div class="h_sto" data-v-17aa6c38><div style="${ssrRenderStyle({ "display": "none" })}" data-v-17aa6c38><div class="error_list" data-v-17aa6c38><!--[-->`);
  ssrRenderList($setup.v$.adress.value.$errors, (element) => {
    _push(`<div data-v-17aa6c38>${ssrInterpolate(element.$message)}</div>`);
  });
  _push(`<!--]--></div><input type="text" placeholder="Адрес"${ssrRenderAttr("value", $setup.v$.adress.value.$model)} data-v-17aa6c38><div class="error_list" data-v-17aa6c38><!--[-->`);
  ssrRenderList($setup.v$.index.value.$errors, (element) => {
    _push(`<div data-v-17aa6c38>${ssrInterpolate(element.$message)}</div>`);
  });
  _push(`<!--]--></div><div class="relative w-sto" data-v-17aa6c38><input type="text"${ssrRenderAttr("value", $setup.v$.index.value.$model)} data-v-17aa6c38><span class="floating-label" data-v-17aa6c38>Your email address</span></div></div>`);
  if ($data.delivery_info) {
    _push(`<div data-v-17aa6c38><div class="relative" data-v-17aa6c38><input type="text" disabled${ssrRenderAttr("value", $data.delivery_info.price)} data-v-17aa6c38><span class="floating-label active" data-v-17aa6c38>Цена</span></div><div class="relative" data-v-17aa6c38><input type="text" disabled${ssrRenderAttr("value", $data.delivery_info.id)} data-v-17aa6c38><span class="floating-label active" data-v-17aa6c38>Номер постмата</span></div><div class="relative" data-v-17aa6c38><input type="text" disabled${ssrRenderAttr("value", $data.delivery_info.PVZ.Address)} data-v-17aa6c38><span class="floating-label active" data-v-17aa6c38>Адрес</span></div><div class="relative" data-v-17aa6c38><input type="text" disabled${ssrRenderAttr("value", $data.delivery_info.term)} data-v-17aa6c38><span class="floating-label active" data-v-17aa6c38>Примерное время доставки</span></div></div>`);
  } else {
    _push(`<!---->`);
  }
  _push(`</div>`);
...
const Checkout = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender$2], ["__scopeId", "data-v-17aa6c38"]]);
async function addOrder$1(address, index) {
  try {
...
const account_css_vue_type_style_index_0_src_f5b3d10f_scoped_f5b3d10f_lang = "";
const _sfc_main$1 = {
  el: "#sub_order",
  ...
  methods: {
    async submin_order() {
      ...
      if (this.forms_validate.status) {
        let response_order = await addOrder$1(this.forms_validate.adress, this.forms_validate.index);
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({
    id: "sub_order",
    class: "w-sto"
  }, _attrs))} data-v-f5b3d10f>`);
  if ($props.items.length) {
    _push(ssrRenderComponent(_component_RouterLink, { to: "/checkout" }, {
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`<button class="w-sto" data-v-f5b3d10f${_scopeId}><div class="fon_btn" data-v-f5b3d10f${_scopeId}></div>Оплатить онлайн</button>`);
        } else {
          return [
            createVNode("button", {
    ...
    _push(ssrRenderComponent(_component_RouterLink, { to: "/catalog" }, {
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`<button class="w-sto" data-v-f5b3d10f${_scopeId}><div class="fon_btn" data-v-f5b3d10f${_scopeId}></div> Добавить товар</button>`);
        } else {
          return [
...
const Submit_order = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-f5b3d10f"]]);
const checkout_vue_vue_type_style_index_0_lang = "";
const account_css_vue_type_style_index_1_src_bea1dcaa_scoped_bea1dcaa_lang = "";
const _sfc_main = {
  el: "#checkout",
  components: {
    BasketInfo,
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "sot-ob" }, _attrs))} data-v-bea1dcaa><div class="wrapper flex" data-v-bea1dcaa><div class="user_card flex auto" data-v-bea1dcaa><div class="interactiv user_card_div auto" id="checkout" data-v-bea1dcaa><div class="w-sto kor" id="kor" data-v-bea1dcaa><p class="small-big VAG" data-v-bea1dcaa>Оформление</p><div class="w-sto flex kor_block jus-sp" data-v-bea1dcaa><div style="${ssrRenderStyle({ "width": "50%", "padding-top": "20px", "padding-left": "2%" })}" data-v-bea1dcaa>`);
  _push(ssrRenderComponent(_component_client_only, null, {}, _parent));
  _push(`<p align="left" class="VAG small" data-v-bea1dcaa>Товары</p>`);
  _push(ssrRenderComponent(_component_order_product_list, {
    orderList: _ctx.$store.getUser.basket
  }, null, _parent));
  _push(`</div><div style="${ssrRenderStyle({ "width": "40%" })}" class="register_zakaz" data-v-bea1dcaa>`);
...
const checkout = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-bea1dcaa"]]);
export {
  checkout as default
};
//# sourceMappingURL=checkout-eb4cf816.js.map
