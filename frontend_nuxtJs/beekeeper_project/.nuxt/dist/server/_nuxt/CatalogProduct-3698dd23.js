...
const katalog_scss_vue_type_style_index_0_src_7eee539a_scoped_7eee539a_lang = "";
const checkbox_scss_vue_type_style_index_1_src_7eee539a_scoped_7eee539a_lang = "";
const CatalogProduct_vue_vue_type_style_index_2_scoped_7eee539a_lang = "";
const _sfc_main = {
  el: "#product_catalog",
  name: "CatalogProduct",
  props: ["pr"],
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<section${ssrRenderAttrs(mergeProps({
    class: "product",
    id: "product_catalog"
  }, _attrs))} data-v-7eee539a><div class="product__photo" data-v-7eee539a><div class="photo-container" data-v-7eee539a><div class="photo-main" data-v-7eee539a><div class="controls" data-v-7eee539a></div><img${ssrRenderAttr("src", _ctx.$api_root + $props.pr.image)} alt="green apple slice" data-v-7eee539a></div>`);
  _push(ssrRenderComponent(_component_TovarMinImageList, {
    image: $props.pr.image,
    ImageProductList: $props.pr.ImageProductList
  }, null, _parent));
  _push(`</div></div><div class="product__info" data-v-7eee539a><div class="title" data-v-7eee539a>`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<p class="small-big product__name" data-v-7eee539a${_scopeId}>${ssrInterpolate($props.pr.name)}</p>`);
      } else {
        return [
  ...
  _push(`<span class="very-small product__code" data-v-7eee539a>COD: ${ssrInterpolate($props.pr.id)}</span></div><div class="price" data-v-7eee539a><span class="product__price small-big" data-v-7eee539a>${ssrInterpolate($props.pr.price)} <span class="product__price small" data-v-7eee539a>${ssrInterpolate($props.pr.price_currency)}</span></span></div>`);
  _push(ssrRenderComponent(_component_rating_comp, {
    rating: $props.pr.rating
  }, null, _parent));
  _push(`<div class="variant" data-v-7eee539a><h3 data-v-7eee539a>Размер</h3><div class="flex" data-v-7eee539a><ul class="variant-ul" data-v-7eee539a><!--[-->`);
  ssrRenderList($props.pr.list_weight, (ls_w, index) => {
    _push(`<li class="${ssrRenderClass([$data.type_weigth_id == ls_w.id ? "active" : "", "photo-album-li"])}" data-v-7eee539a><div class="h_sto" data-v-7eee539a><p data-v-7eee539a>${ssrInterpolate(ls_w.weight)} гр</p></div></li>`);
  });
  _push(`<!--]--></ul></div><h3 data-v-7eee539a>Тип упаковки</h3><div class="flex" data-v-7eee539a><ul class="variant-ul" data-v-7eee539a><!--[-->`);
  ssrRenderList($props.pr.type_packaging, (ty_pck, index) => {
    _push(`<li class="${ssrRenderClass([$data.type_pack_id == ty_pck.id ? "active" : "", "photo-album-li"])}" data-v-7eee539a><div class="h_sto" data-v-7eee539a><p data-v-7eee539a>${ssrInterpolate(ty_pck.name)}</p></div></li>`);
  });
  _push(`<!--]--></ul></div></div><div class="product__text" data-v-7eee539a><p class="small" data-v-7eee539a>${ssrInterpolate($props.pr.description)}</p></div><div class="flex" data-v-7eee539a>`);
...
const CatalogProduct = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-7eee539a"]]);
export {
  CatalogProduct as C,
  TovarMinImageList as T
};
//# sourceMappingURL=CatalogProduct-3698dd23.js.map
