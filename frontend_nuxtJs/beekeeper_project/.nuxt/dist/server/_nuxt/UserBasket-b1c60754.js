import { B as BasketInfo } from "./BasketInfo-a5de23ab.js";
import { A as AddBasket, F as FavoriteComp } from "./FavoriteComp-e63eb626.js";
...
const account_css_vue_type_style_index_0_src_2d412ae2_scoped_2d412ae2_lang = "";
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "list_tovar_kor w-sto" }, _attrs))} data-v-2d412ae2><!--[-->`);
  ssrRenderList($data.USER_STATE.basket, (b) => {
    _push(`<div class="tovar w-sto flex" data-v-2d412ae2><div class="tovar_kor_img_div" data-v-2d412ae2><img class="tovar_kor_img"${ssrRenderAttr("src", _ctx.$api_root + b.productItem.product.image)} alt="" data-v-2d412ae2></div><div class="info_tovar_kor flex jus-sp" data-v-2d412ae2><div class="info_tovar_kor_osnov" data-v-2d412ae2><p class="normal-small tovar_kor_name" data-v-2d412ae2>${ssrInterpolate(b.productItem.product.name)} [${ssrInterpolate(b.productItem.weight.weight)} гр]</p><p class="normal-small info_in_tovar_kor" data-v-2d412ae2>${ssrInterpolate(b.productItem.product.price)} ${ssrInterpolate(b.productItem.product.price_currency)}</p><div class="btn_tovar_kor flex" data-v-2d412ae2>`);
    ...
    _push(`</div></div><div class="size_tovar_div" data-v-2d412ae2><div class="size_tovar_kor" data-v-2d412ae2><div class="select_size" data-v-2d412ae2><button style="${ssrRenderStyle({ "background": "rgb(76, 175, 80)", "cursor": "pointer", "width": "100%", "height": "32px", "border": "none", "border-radius": "6px" })}" onclick="alert(&#39;в разработке&#39;)" data-v-2d412ae2>Изменить</button><p class="normal-small kolvo" data-v-2d412ae2>количество</p>`);
    _push(ssrRenderComponent(_component_CountProduct, { item: b }, null, _parent));
    _push(`</div></div></div></div></div>`);
  });
  _push(`<!--]-->`);
  if (!$data.USER_STATE.basket.length) {
    _push(`<div style="${ssrRenderStyle({ "width": "50%", "margin": "auto", "margin-top": "10%" })}" data-v-2d412ae2><p style="${ssrRenderStyle({ "font-size": "28px" })}" class="VAG" data-v-2d412ae2>Список корзины пуст :(</p><div class="select_size" data-v-2d412ae2>`);
    _push(ssrRenderComponent(_component_router_link, { to: "/catalog" }, {
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`<button style="${ssrRenderStyle({ "background": "rgb(76, 175, 80)", "cursor": "pointer", "width": "100%", "border": "medium none", "border-radius": "6px", "font-size": "26px", "padding": "2%", "margin-top": "1%" })}" data-v-2d412ae2${_scopeId}> Перейти в каталог </button>`);
        } else {
          return [
...
const BasketList = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-2d412ae2"]]);
...
//# sourceMappingURL=UserBasket-b1c60754.js.map
