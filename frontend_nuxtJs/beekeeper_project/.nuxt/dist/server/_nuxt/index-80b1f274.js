...
import { C as CatalogProduct, T as TovarMinImageList, R as RatingComp, S as SelectVariantMenu } from "./CatalogProduct-d9160a57.js";
...
import "ohash";
import "defu";
const main_css_vue_type_style_index_0_src_0708b8a4_scoped_0708b8a4_lang = "";
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<section${ssrRenderAttrs(mergeProps({
    class: "product",
    id: "product_catalog"
  }, _attrs))} data-v-0708b8a4><div class="product__photo" data-v-0708b8a4><div class="photo-container" data-v-0708b8a4><div class="photo-main" data-v-0708b8a4><div class="controls" data-v-0708b8a4></div>`);
  ...
  _push(`</div></div><div class="product__info" data-v-0708b8a4><div class="title" data-v-0708b8a4>`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<p class="small-big product__name" data-v-0708b8a4${_scopeId}>${ssrInterpolate($props.pr.name)}</p>`);
      } else {
        return [
  ...
  _push(`<span class="very-small product__code" data-v-0708b8a4>COD: ${ssrInterpolate($props.pr.id)}</span></div>`);
  _push(ssrRenderComponent(_component_rating_comp, {
    rating: $props.pr.rating
  }, null, _parent));
  _push(`<div class="price" data-v-0708b8a4><span class="product__price small-big" data-v-0708b8a4>${ssrInterpolate(_ctx.select_productItem.price)} <span class="product__price small" data-v-0708b8a4>${ssrInterpolate($props.pr.price_currency)}</span></span></div>`);
  ...
  _push(`<div class="product__text" data-v-0708b8a4><p class="small" data-v-0708b8a4>${ssrInterpolate($props.pr.description.slice(15))}...</p></div><div style="${ssrRenderStyle(_ctx.select_productItem.weight ? "margin-top: 8px" : "margin-top: 56px")}" class="flex" data-v-0708b8a4>`);
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender$2], ["__scopeId", "data-v-0708b8a4"]]);
...
//# sourceMappingURL=index-80b1f274.js.map
