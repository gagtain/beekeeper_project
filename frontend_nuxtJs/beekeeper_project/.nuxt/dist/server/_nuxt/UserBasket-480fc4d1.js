...
import { A as AddBasket, F as FavoriteComp } from "./FavoriteComp-c429b5cb.js";
...
const account_css_vue_type_style_index_0_src_5a39c212_scoped_5a39c212_lang = "";
const BasketInfo_vue_vue_type_style_index_1_scoped_5a39c212_lang = "";
const _sfc_main$3 = {
  el: "#reg_zakaz",
  name: "BasketInfo",
  data() {
...
function _sfc_ssrRender$3(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "register_zakaz" }, _attrs))} data-v-5a39c212>`);
  if ($data.USER_STATE.basket.length) {
    _push(`<button class="w-sto" data-v-5a39c212><div class="fon_btn" data-v-5a39c212></div>Оформить</button>`);
  } else {
    _push(ssrRenderComponent(_component_RouterLink, { to: "/catalog" }, {
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`<button class="w-sto" data-v-5a39c212${_scopeId}><div class="fon_btn" data-v-5a39c212${_scopeId}></div> Добавить товар</button>`);
        } else {
          return [
  ...
  _push(`<div class="kor_all_info auto w-sto m-2" data-v-5a39c212><p class="m2" data-v-5a39c212>Товаров: ${ssrInterpolate($options.getCountBasket())}</p><p class="m2" data-v-5a39c212>Вес: ${ssrInterpolate($options.getWeight())}</p><p class="m2" data-v-5a39c212> Цена: ${ssrInterpolate($data.USER_STATE.basket.reduce(function(sum, elem) {
    return sum + parseFloat(elem.productItem.product.price);
  }, 0))}</p><p class="m2" data-v-5a39c212>скидки:</p><ul data-v-5a39c212><li data-v-5a39c212>*в разработке*</li></ul><p id="is" class="small" data-v-5a39c212> Итоговая сумма: ${ssrInterpolate($options.getSumm())}</p></div></div>`);
}
...
const BasketInfo = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["ssrRender", _sfc_ssrRender$3], ["__scopeId", "data-v-5a39c212"]]);
...
const account_css_vue_type_style_index_0_src_4b1e6b6d_scoped_4b1e6b6d_lang = "";
const _sfc_main = {
  el: "#kor",
  name: "UserBasket",
  components: {
...
//# sourceMappingURL=UserBasket-480fc4d1.js.map
