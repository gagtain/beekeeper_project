import { C as CatalogProduct } from "./CatalogProduct-f2602567.js";
...
const katalog_scss_vue_type_style_index_0_src_fc1773fb_scoped_fc1773fb_lang = "";
const checkbox_scss_vue_type_style_index_1_src_fc1773fb_scoped_fc1773fb_lang = "";
const hexTovar_css_vue_type_style_index_2_src_true_lang = "";
const catalog_vue_vue_type_style_index_3_scoped_fc1773fb_lang = "";
const _sfc_main = {
  el: "#catalog",
  name: "CatalogItem",
  components: {
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ id: "catalog" }, _attrs))} data-v-fc1773fb><div class="absolute flex w-sto h_sto" style="${ssrRenderStyle({ "pointer-events": "none" })}" data-v-fc1773fb><dialog id="dialog" class="absolute auto" style="${ssrRenderStyle({ "pointer-events": "auto" })}" data-v-fc1773fb>`);
  ...
  _push(`<button class="btn w-sto btn-green" onclick="window.dialog.close();" data-v-fc1773fb>Показать</button><button onclick="window.dialog.close();" aria-label="close" class="x" data-v-fc1773fb> ❌ </button></dialog></div><div class="sot-ob" data-v-fc1773fb><div class="wrapper-product w-sto flex" data-v-fc1773fb><div class="interactiv auto back" data-v-fc1773fb>`);
  if ($data.filters) {
    _push(`<p style="${ssrRenderStyle({ "margin-left": "5%" })}" class="small" data-v-fc1773fb>${ssrInterpolate(JSON.parse(this.$route.query.filter).name)}</p>`);
  } else {
    _push(`<!---->`);
  }
  _push(`<div class="flex w-sto product_div" data-v-fc1773fb><div class="block filter_div" data-v-fc1773fb><div class="filter-product" id="filter_desk" data-v-fc1773fb>`);
  _push(ssrRenderComponent(_component_FilterCatalog, {
    category_list: $data.category_list,
    catalog_list: $data.catalog_list
  }, null, _parent));
  _push(`</div></div><div class="product_osnov relative" data-v-fc1773fb><div class="sorted_div flex jus-sp" data-v-fc1773fb>`);
  _push(ssrRenderComponent(_component_SortedCatalog, { catalog_list: $data.catalog_list }, null, _parent));
  _push(`<div class="mob_filter flex" data-v-fc1773fb><img onclick="window.dialog.showModal();" class="open_filter_mob auto"${ssrRenderAttr("src", _imports_0)} alt="" data-v-fc1773fb></div></div>`);
  if ($data.catalog_list.length) {
    _push(`<div class="w-sto product-list flex" data-v-fc1773fb><!--[-->`);
    ...
    _push(`<div style="${ssrRenderStyle({ "width": "50%", "margin": "auto", "margin-top": "10%" })}" data-v-fc1773fb><div style="${ssrRenderStyle({ "text-align": "center" })}" class="flex w-sto" data-v-fc1773fb><p style="${ssrRenderStyle({ "font-size": "28px" })}" class="VAG auto" data-v-fc1773fb>Товаров с выбранными параметрами нету :(</p></div><div class="select_size" data-v-fc1773fb>`);
    _push(ssrRenderComponent(_component_NuxtLink, { to: "/catalog" }, {
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`<button style="${ssrRenderStyle({ "background": "rgb(255, 188, 65)", "cursor": "pointer", "width": "100%", "border": "medium none", "border-radius": "6px", "font-size": "26px", "padding": "2%", "margin-top": "1%" })}" data-v-fc1773fb${_scopeId}> Сбросить настройки </button>`);
        } else {
          return [
            createVNode("button", {
...
const catalog = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-fc1773fb"]]);
export {
  catalog as default
};
//# sourceMappingURL=catalog-789c1bd7.js.map
