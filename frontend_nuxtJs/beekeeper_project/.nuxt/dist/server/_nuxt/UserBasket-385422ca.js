...
import { A as AddBasket, F as FavoriteComp } from "./FavoriteComp-ed45f3a2.js";
...
const account_css_vue_type_style_index_0_src_7a9e31d5_scoped_7a9e31d5_lang = "";
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "list_tovar_kor w-sto" }, _attrs))} data-v-7a9e31d5><!--[-->`);
  ssrRenderList($data.USER_STATE.basket, (b) => {
    _push(`<div class="tovar w-sto flex" data-v-7a9e31d5><div class="tovar_kor_img_div" data-v-7a9e31d5><img class="tovar_kor_img"${ssrRenderAttr("src", _ctx.$api_root + b.productItem.product.image)} alt="" data-v-7a9e31d5></div><div class="info_tovar_kor flex jus-sp" data-v-7a9e31d5><div class="info_tovar_kor_osnov" data-v-7a9e31d5><p class="normal-small tovar_kor_name" data-v-7a9e31d5>${ssrInterpolate(b.productItem.product.name)} ${ssrInterpolate(b.productItem.weight ? "[" + b.productItem.weight.weight + "гр]" : "")}</p><p class="normal-small info_in_tovar_kor" data-v-7a9e31d5>${ssrInterpolate(b.productItem.price)} ${ssrInterpolate(b.productItem.price_currency)}</p><div class="btn_tovar_kor flex" data-v-7a9e31d5>`);
    ...
    _push(`</div></div><div class="size_tovar_div" data-v-7a9e31d5><div class="size_tovar_kor" data-v-7a9e31d5><div class="select_size" data-v-7a9e31d5><p class="normal-small kolvo" data-v-7a9e31d5>количество</p>`);
    _push(ssrRenderComponent(_component_CountProduct, { item: b }, null, _parent));
    _push(`</div></div></div></div></div>`);
  });
  _push(`<!--]-->`);
  if (!$data.USER_STATE.basket.length) {
    _push(`<div style="${ssrRenderStyle({ "width": "50%", "margin": "auto", "margin-top": "10%" })}" data-v-7a9e31d5><p style="${ssrRenderStyle({ "font-size": "28px" })}" class="VAG" data-v-7a9e31d5>Список корзины пуст :(</p><div class="select_size" data-v-7a9e31d5>`);
    _push(ssrRenderComponent(_component_router_link, { to: "/catalog" }, {
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`<button style="${ssrRenderStyle({ "background": "rgb(76, 175, 80)", "cursor": "pointer", "width": "100%", "border": "medium none", "border-radius": "6px", "font-size": "26px", "padding": "2%", "margin-top": "1%" })}" data-v-7a9e31d5${_scopeId}> Перейти в каталог </button>`);
        } else {
          return [
...
const BasketList = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-7a9e31d5"]]);
...
//# sourceMappingURL=UserBasket-385422ca.js.map
