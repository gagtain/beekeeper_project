import { _ as _export_sfc, e as __nuxt_component_0$1, a as api_root, u as useHead } from "../server.mjs";
import { A as AddBasket, F as FavoriteComp } from "./FavoriteComp-5b75aa9c.js";
import { C as CatalogProduct, T as TovarMinImageList, R as RatingComp, S as SelectVariantMenu } from "./CatalogProduct-ec41acc4.js";
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender$2], ["__scopeId", "data-v-1e3c0ef3"]]);
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-d5e5ae5a"]]);
const swiper_min = "";
const _imports_0 = "" + __buildAssetsURL("eco-friend.3cab6412.jpg");
const index_vue_vue_type_style_index_0_lang = "";
const main_css_vue_type_style_index_1_src_008d68cb_scoped_008d68cb_lang = "";
const news_min_css_vue_type_style_index_2_src_008d68cb_scoped_008d68cb_lang = "";
const hexTovar_css_vue_type_style_index_3_src_008d68cb_scoped_008d68cb_lang = "";
const index_vue_vue_type_style_index_4_scoped_008d68cb_lang = "";
const _sfc_main = {
  name: "IndexItem",
  components: {
    Swiper,
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ style: { "padding-top": "50px" } }, _attrs))} data-v-008d68cb><div class="wrapper" data-v-008d68cb><div class="${ssrRenderClass([$data.wrapper_active ? "actives" : "", "absolute main-nak"])}" data-v-008d68cb></div><div class="main relative" data-v-008d68cb><div class="interactiv flex" data-v-008d68cb><div class="main_center auto" data-v-008d68cb><div class="main_text_div auto" data-v-008d68cb><p class="main_text" data-v-008d68cb>Наш мед имеет ряд преимуществ!</p><div class="bt" data-v-008d68cb><button class="main_bt" data-v-008d68cb><div class="flex sto" data-v-008d68cb><p class="main_bt_p" data-v-008d68cb>Попробовать!</p></div></button></div></div>`);
  if (!_ctx.$device.isMobile) {
    _push(`<div class="main_img_div" data-v-008d68cb><img${ssrRenderAttr("src", `${_ctx.$api_root}static/online_store/images/phel.png`)} class="phel" alt="" data-v-008d68cb><div class="slider-produtos-wrap h_sto" data-v-008d68cb>`);
        ...
        if (_push2) {
          _push2(ssrRenderComponent(_component_swiper_slide, null, {
            default: withCtx((_2, _push3, _parent3, _scopeId2) => {
              if (_push3) {
                _push3(`<img${ssrRenderAttr("src", _ctx.$api_root + "static/online_store/images/honey.png")} class="main_img" width="100%" height="100%" alt="" data-v-008d68cb${_scopeId2}>`);
              } else {
                return [
                  createVNode("img", {
  ...
  _push(`</div></div></div></div><div class="sot" data-v-008d68cb><div class="interactiv auto" data-v-008d68cb><div class="flex w-sto text_in_sot" data-v-008d68cb><p class="big auto main-text" data-v-008d68cb>Популярные товары</p></div><div class="block_info sliders big-block" data-v-008d68cb><div class="slider-produtos-wrap" data-v-008d68cb>`);
  if ($data.popular_product != null) {
        ...
        if (_push2) {
          ...
          ssrRenderList($data.popular_product, (pop_product) => {
            _push2(ssrRenderComponent(_component_swiper_slide, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="hex slide auto" data-v-008d68cb${_scopeId2}>`);
    ...
    _push(`<div class="w-sto h_sto" data-v-008d68cb>`);
    _push(ssrRenderComponent(_component_LoadingComp, null, null, _parent));
    _push(`</div>`);
  }
  _push(`</div></div><div style="${ssrRenderStyle({ "display": "block" })}" class="block_info" data-v-008d68cb><div class="flex w-sto jus-sp info_kart_div" data-v-008d68cb><div class="kart" data-v-008d68cb><div class="w-sto h_sto" data-v-008d68cb><img style="${ssrRenderStyle({ "border-radius": "40px" })}" class="w-sto h_sto"${ssrRenderAttr("src", _imports_0)} alt="" data-v-008d68cb></div></div><div class="dostav_info flex" data-v-008d68cb><div class="w-sto auto" data-v-008d68cb><p class="small-big VAG" style="${ssrRenderStyle({ "line-height": "1" })}" data-v-008d68cb>Чистый как золото, на вкус как солнечный свет</p><p class="small m2" data-v-008d68cb> Наш мед является исключительно натуральным продуктом. Без примесей, без химии. </p></div></div></div></div><div class="interactiv auto" data-v-008d68cb><div class="flex w-sto text_in_sot" data-v-008d68cb><p class="big auto main-text" data-v-008d68cb>Новости</p></div><section style="${ssrRenderStyle({ "padding": "5%" })}" class="auto grid" data-v-008d68cb><!--[-->`);
  ssrRenderList($data.news, (new_obj) => {
    _push(`<article class="grid-item" data-v-008d68cb><div class="image" data-v-008d68cb><img${ssrRenderAttr("src", this.$api_root + new_obj.main_image)} data-v-008d68cb></div><div class="info" data-v-008d68cb>`);
    _push(ssrRenderComponent(_component_NuxtLink, {
      "no-prefetch": "",
      to: `/news/${new_obj.id}`
    }, {
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`<h2 class="VAG" data-v-008d68cb${_scopeId}>${ssrInterpolate(new_obj.title)}</h2>`);
        } else {
          return [
    ...
    _push(`<div class="info-text" data-v-008d68cb><p data-v-008d68cb>${ssrInterpolate(new_obj.main_text.slice(40))}...</p></div><div class="button-wrap" data-v-008d68cb>`);
    _push(ssrRenderComponent(_component_NuxtLink, {
      "no-prefetch": "",
      class: "atuin-btn",
      to: `/news/${new_obj.id}`
  ...
  _push(ssrRenderComponent(_component_NuxtLink, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<button style="${ssrRenderStyle({ "background": "rgb(160,166,62)", "cursor": "pointer", "width": "100%", "border": "none", "border-radius": "6px", "padding": "2% 3%" })}" data-v-008d68cb${_scopeId}><div class="w-sto h_sto flex" data-v-008d68cb${_scopeId}><p class="auto small-big" data-v-008d68cb${_scopeId}>Все новости</p></div></button>`);
      } else {
        return [
  ...
  if (!_ctx.$store.getUser.is_sending) {
    _push(`<div class="interactiv auto" data-v-008d68cb><div class="flex w-sto text_in_sot" data-v-008d68cb><p class="big auto main-text" data-v-008d68cb>Рассылка</p></div>`);
    _push(ssrRenderComponent(_component_Sending, null, null, _parent));
    _push(`</div>`);
  } else {
    _push(`<!---->`);
  }
  _push(`</div><div class="ref-block w-sto" data-v-008d68cb><div class="flex w-sto text_in_sot" data-v-008d68cb><p class="big auto main-text" style="${ssrRenderStyle({ "color": "rgb(241, 195, 96)", "text-shadow": "10px 10px 10px black", "padding": "1%" })}" data-v-008d68cb>О нашем товаре</p></div><div class="interactiv auto h-sto flex" data-v-008d68cb><div class="block_info o_product auto" data-v-008d68cb><div class="predp" data-v-008d68cb><div class="predp-img auto" data-v-008d68cb><img width="100%" height="100%"${ssrRenderAttr("src", _ctx.$api_root + "static/online_store/images/3.jpg")} alt="" data-v-008d68cb></div><p class="small-big predp-name" data-v-008d68cb>Иваненко И.П.</p><p class="small" data-v-008d68cb>Директор компании ...</p></div><div class="predp-text flex" data-v-008d68cb><p class="small-big" data-v-008d68cb> Наша доставка распространяется на города: Lorem ipsum dolor sit amet consectetur adipisicing elit. Enim, architecto veritatis? Aut iure labore qui ut molestiae minima repudiandae obcaecati beatae illo. Aliquam debitis minus consequuntur illum et natus. Incidunt. </p></div></div></div><div class="interactiv" data-v-008d68cb></div></div></div></div>`);
}
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-008d68cb"]]);
export {
  index as default
};
//# sourceMappingURL=index-fc3a4131.js.map
