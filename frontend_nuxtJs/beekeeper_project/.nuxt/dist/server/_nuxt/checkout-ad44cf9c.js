...
const account_css_vue_type_style_index_0_src_1b331f1d_scoped_1b331f1d_lang = "";
const _sfc_main$1 = {
  el: "#sub_order",
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({
    id: "sub_order",
    class: "w-sto"
  }, _attrs))} data-v-1b331f1d>`);
  if ($props.items.length) {
    _push(ssrRenderComponent(_component_RouterLink, { to: "/checkout" }, {
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`<button class="w-sto" data-v-1b331f1d${_scopeId}><div class="fon_btn" data-v-1b331f1d${_scopeId}></div>Оплатить онлайн</button>`);
        } else {
          return [
            createVNode("button", {
    ...
    _push(ssrRenderComponent(_component_RouterLink, { to: "/catalog" }, {
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`<button class="w-sto" data-v-1b331f1d${_scopeId}><div class="fon_btn" data-v-1b331f1d${_scopeId}></div> Добавить товар</button>`);
        } else {
          return [
...
const Submit_order = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-1b331f1d"]]);
...
//# sourceMappingURL=checkout-ad44cf9c.js.map
