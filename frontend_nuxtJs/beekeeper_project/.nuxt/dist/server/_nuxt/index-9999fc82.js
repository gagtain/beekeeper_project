...
const main_css_vue_type_style_index_1_src_6cb96433_scoped_6cb96433_lang = "";
const news_min_css_vue_type_style_index_2_src_6cb96433_scoped_6cb96433_lang = "";
const hexTovar_css_vue_type_style_index_3_src_6cb96433_scoped_6cb96433_lang = "";
const index_vue_vue_type_style_index_4_scoped_6cb96433_lang = "";
const _sfc_main = {
  name: "IndexItem",
  components: {
    Swiper,
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ style: { "padding-top": "50px" } }, _attrs))} data-v-6cb96433><div class="wrapper" data-v-6cb96433>`);
  ...
  _push(`<div class="${ssrRenderClass([$data.wrapper_active ? "actives" : "", "absolute main-nak"])}" data-v-6cb96433></div><div class="main relative" data-v-6cb96433><div class="interactiv flex" data-v-6cb96433><div class="main_center auto" data-v-6cb96433><div class="main_text_div auto" data-v-6cb96433><p class="main_text" data-v-6cb96433>Наш мед имеет ряд преимуществ!</p><div class="bt" data-v-6cb96433><button class="main_bt" data-v-6cb96433><div class="flex sto" data-v-6cb96433><p class="main_bt_p" data-v-6cb96433>Попробовать!</p></div></button></div></div>`);
  if (!_ctx.$device.isMobile) {
    _push(`<div class="main_img_div" data-v-6cb96433><img${ssrRenderAttr("src", `${_ctx.$api_root}static/online_store/images/phel.png`)} class="phel" alt="" data-v-6cb96433><div class="slider-produtos-wrap h_sto" data-v-6cb96433>`);
        ...
        if (_push2) {
          _push2(ssrRenderComponent(_component_swiper_slide, null, {
            default: withCtx((_2, _push3, _parent3, _scopeId2) => {
              if (_push3) {
                _push3(`<img${ssrRenderAttr("src", _ctx.$api_root + "static/online_store/images/honey.png")} class="main_img" width="100%" height="100%" alt="" data-v-6cb96433${_scopeId2}>`);
              } else {
                return [
                  createVNode("img", {
  ...
  _push(`</div></div></div></div><div class="sot" data-v-6cb96433><div class="interactiv auto" data-v-6cb96433><div class="flex w-sto text_in_sot" data-v-6cb96433><p class="big auto main-text" data-v-6cb96433>Популярные товары</p></div><div class="block_info sliders big-block" data-v-6cb96433><div class="slider-produtos-wrap" data-v-6cb96433>`);
  if ($data.popular_product != null) {
        ...
        if (_push2) {
          ...
          ssrRenderList($data.popular_product, (pop_product) => {
            _push2(ssrRenderComponent(_component_swiper_slide, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="hex slide auto" data-v-6cb96433${_scopeId2}>`);
    ...
    _push(`<div class="w-sto h_sto" data-v-6cb96433>`);
    _push(ssrRenderComponent(_component_LoadingComp, null, null, _parent));
    _push(`</div>`);
  }
  _push(`</div></div><div style="${ssrRenderStyle({ "display": "block" })}" class="block_info" data-v-6cb96433><div class="flex w-sto jus-sp info_kart_div" data-v-6cb96433><div class="kart" data-v-6cb96433><div class="w-sto h_sto" data-v-6cb96433><img style="${ssrRenderStyle({ "border-radius": "40px" })}" class="w-sto h_sto"${ssrRenderAttr("src", _imports_0)} alt="" data-v-6cb96433></div></div><div class="dostav_info flex" data-v-6cb96433><div class="w-sto auto" data-v-6cb96433><p class="small-big VAG" style="${ssrRenderStyle({ "line-height": "1" })}" data-v-6cb96433>Чистый как золото, на вкус как солнечный свет</p><p class="small m2" data-v-6cb96433> Наш мед является исключительно натуральным продуктом. Без примесей, без химии. </p></div></div></div></div><div class="interactiv auto" data-v-6cb96433><div class="flex w-sto text_in_sot" data-v-6cb96433><p class="big auto main-text" data-v-6cb96433>Новости</p></div><section style="${ssrRenderStyle({ "padding": "5%" })}" class="auto grid" data-v-6cb96433><!--[-->`);
  ssrRenderList($data.news, (new_obj) => {
    _push(`<article class="grid-item" data-v-6cb96433><div class="image" data-v-6cb96433><img${ssrRenderAttr("src", this.$api_root + new_obj.main_image)} data-v-6cb96433></div><div class="info" data-v-6cb96433>`);
    _push(ssrRenderComponent(_component_NuxtLink, {
      "no-prefetch": "",
      to: `/news/${new_obj.id}`
    }, {
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`<h2 class="VAG" data-v-6cb96433${_scopeId}>${ssrInterpolate(new_obj.title)}</h2>`);
        } else {
          return [
    ...
    _push(`<div class="info-text" data-v-6cb96433><p data-v-6cb96433>${ssrInterpolate(new_obj.main_text.slice(40))}...</p></div><div class="button-wrap" data-v-6cb96433>`);
    _push(ssrRenderComponent(_component_NuxtLink, {
      "no-prefetch": "",
      class: "atuin-btn",
      to: `/news/${new_obj.id}`
  ...
  _push(ssrRenderComponent(_component_NuxtLink, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<button style="${ssrRenderStyle({ "background": "rgb(160,166,62)", "cursor": "pointer", "width": "100%", "border": "none", "border-radius": "6px", "padding": "2% 3%" })}" data-v-6cb96433${_scopeId}><div class="w-sto h_sto flex" data-v-6cb96433${_scopeId}><p class="auto small-big" data-v-6cb96433${_scopeId}>Все новости</p></div></button>`);
      } else {
        return [
  ...
  if (!_ctx.$store.getUser.is_sending) {
    _push(`<div class="interactiv auto" data-v-6cb96433><div class="flex w-sto text_in_sot" data-v-6cb96433><p class="big auto main-text" data-v-6cb96433>Рассылка</p></div>`);
    _push(ssrRenderComponent(_component_Sending, null, null, _parent));
    _push(`</div>`);
  } else {
    _push(`<!---->`);
  }
  _push(`</div><div class="ref-block w-sto" data-v-6cb96433><div class="flex w-sto text_in_sot" data-v-6cb96433><p class="big auto main-text" style="${ssrRenderStyle({ "color": "rgb(241, 195, 96)", "text-shadow": "10px 10px 10px black", "padding": "1%" })}" data-v-6cb96433>О нашем товаре</p></div><div class="interactiv auto h-sto flex" data-v-6cb96433><div class="block_info o_product auto" data-v-6cb96433><div class="predp" data-v-6cb96433><div class="predp-img auto" data-v-6cb96433><img width="100%" height="100%"${ssrRenderAttr("src", _ctx.$api_root + "static/online_store/images/3.jpg")} alt="" data-v-6cb96433></div><p class="small-big predp-name" data-v-6cb96433>Иваненко И.П.</p><p class="small" data-v-6cb96433>Директор компании ...</p></div><div class="predp-text flex" data-v-6cb96433><p class="small-big" data-v-6cb96433> Наша доставка распространяется на города: Lorem ipsum dolor sit amet consectetur adipisicing elit. Enim, architecto veritatis? Aut iure labore qui ut molestiae minima repudiandae obcaecati beatae illo. Aliquam debitis minus consequuntur illum et natus. Incidunt. </p></div></div></div><div class="interactiv" data-v-6cb96433></div></div></div></div>`);
}
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-6cb96433"]]);
export {
  index as default
};
//# sourceMappingURL=index-9999fc82.js.map
