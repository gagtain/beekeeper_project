...
import { U as UserBasket } from "./UserBasket-67d12d7b.js";
import "ofetch";
...
import "./FavoriteComp-c0352682.js";
import "./FavoriteComp-443120c2.js";
...
const account_css_vue_type_style_index_0_src_c5c08336_scoped_c5c08336_lang = "";
const _sfc_main$3 = {
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({
    class: "user_kor_zak",
    id: "UserInfoRen"
  }, _attrs))} data-v-c5c08336><div class="user_kor flex relative" data-v-c5c08336><div class="w-sto h_sto s flex absolute" data-v-c5c08336><div class="auto edit-user_info h_sto" data-v-c5c08336><button onclick="alert(&#39;В разработке&#39;)" class="edit-user_info_btn auto" data-v-c5c08336> Изменить данные </button></div></div><div class="auto edit_block w-sto" style="${ssrRenderStyle({ "filter": "blur(10px)" })}" data-v-c5c08336><input type="text" class="user_form_input" placeholder="username" data-v-c5c08336><input type="password" class="user_form_input" placeholder="password" data-v-c5c08336><button class="edit-user_info_btn auto" data-v-c5c08336>Подтвердить</button></div></div><div class="user_zak relative" data-v-c5c08336><p class="small" data-v-c5c08336>Последний заказ</p>`);
  if ($data.last_order.amount) {
    _push(`<div class="end_zakaz" data-v-c5c08336><div class="end_zakaz_img flex" data-v-c5c08336><img style="${ssrRenderStyle({ "aspect-ratio": "1/1" })}" class="auto w-sto"${ssrRenderAttr("src", _ctx.$api_root + $data.last_order.product_list_transaction[0].productItem.product.image.slice(1))} alt="" data-v-c5c08336></div><div class="end_zakaz_info flex" data-v-c5c08336><div class="auto end_zakaz_info_p_all" data-v-c5c08336><div class="block w-sto" data-v-c5c08336><p class="normal-small end_zakaz_info_p" data-v-c5c08336>Цена:</p><span class="info_end_zakaz_span" data-v-c5c08336>${ssrInterpolate($data.last_order.amount)}</span></div><div class="block w-sto" data-v-c5c08336><p class="normal-small end_zakaz_info_p" data-v-c5c08336> Дата офомления: </p><span class="info_end_zakaz_span" data-v-c5c08336>20-10-23</span></div><div class="block" data-v-c5c08336><p class="normal-small end_zakaz_info_p" data-v-c5c08336>Статус:</p><span class="info_end_zakaz_span" data-v-c5c08336>В пути</span></div></div></div></div>`);
  } else if ($data.isLastOrder_loading) {
    _push(ssrRenderComponent(_component_LoadingComp, null, null, _parent));
  } else {
    _push(`<div class="auto" data-v-c5c08336><p style="${ssrRenderStyle({ "font-size": "28px" })}" class="VAG" data-v-c5c08336>Список заказов пуст :(</p><div class="select_size" data-v-c5c08336>`);
    _push(ssrRenderComponent(_component_router_link, { to: "/basket" }, {
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`<button style="${ssrRenderStyle({ "background": "rgb(76, 175, 80)", "cursor": "pointer", "width": "100%", "border": "medium none", "border-radius": "6px", "font-size": "26px", "padding": "2%", "margin-top": "1%" })}" data-v-c5c08336${_scopeId}> Перейти в корзину </button>`);
        } else {
          return [
...
const UserInfoRen = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["ssrRender", _sfc_ssrRender$2], ["__scopeId", "data-v-c5c08336"]]);
...
const account_css_vue_type_style_index_1_src_49dbf11f_scoped_49dbf11f_lang = "";
const _sfc_main$2 = {
  methods: {
    re_image() {
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "user_img_profile relative" }, _attrs))} data-v-49dbf11f><img${ssrRenderAttr("src", _ctx.$api_root + _ctx.$store.getUser.image.slice(1))} alt="" data-v-49dbf11f><div class="absolute w-sto h_sto flex" data-v-49dbf11f><input style="${ssrRenderStyle({ "display": "none" })}" type="file" src="" id="user_image_input" accept="image/*" alt="" data-v-49dbf11f><button class="auto" style="${ssrRenderStyle({ "background": "rgb(76, 175, 80)", "cursor": "pointer", "width": "100%", "border": "medium none", "border-radius": "6px", "font-size": "26px", "padding": "2%", "height": "auto" })}" data-v-49dbf11f> Изменить </button></div></div>`);
}
...
const UserImage = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-49dbf11f"]]);
...
//# sourceMappingURL=profile-2c3c572e.js.map
