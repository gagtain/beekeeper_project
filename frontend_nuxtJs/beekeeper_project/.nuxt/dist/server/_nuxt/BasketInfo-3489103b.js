...
const account_css_vue_type_style_index_0_src_322b4070_scoped_322b4070_lang = "";
const _sfc_main$1 = {
  el: "#pr_list_info",
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  }, _attrs))} data-v-322b4070><p class="m2" data-v-322b4070>Товаров: ${ssrInterpolate($options.getCountBasket())}</p><p class="m2" data-v-322b4070>Вес: ${ssrInterpolate($options.getWeight())}</p><p class="m2" data-v-322b4070> Цена: ${ssrInterpolate($props.items.reduce(function(sum, elem) {
    return sum + parseFloat(elem.productItem.price);
  }, 0))}</p>`);
  if ($props.ordered) {
    _push(`<p class="m2" data-v-322b4070>Цена доставки ${ssrInterpolate($props.delivery_price)}</p>`);
  } else {
    _push(`<!---->`);
  }
  _push(`<p class="m2" data-v-322b4070>скидки:</p><ul data-v-322b4070><li data-v-322b4070>*в разработке*</li></ul><p id="is" class="small" data-v-322b4070> Итоговая сумма: ${ssrInterpolate($options.getSumm())}</p></div>`);
}
...
const ProductListInfo = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-322b4070"]]);
...
//# sourceMappingURL=BasketInfo-3489103b.js.map
