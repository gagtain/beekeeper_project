...
import { B as BasketInfo, P as ProductListInfo } from "./BasketInfo-48c56383.js";
...
const checkbox_scss_vue_type_style_index_0_src_0433fbb5_scoped_0433fbb5_lang = "";
const Checkout_vue_vue_type_style_index_1_scoped_0433fbb5_lang = "";
const Checkout_vue_vue_type_style_index_2_scoped_0433fbb5_lang = "";
const _sfc_main$2 = {
  components: { SDEKcart },
  el: "#check_form",
  data() {
...
const account_css_vue_type_style_index_0_src_78cfcdde_scoped_78cfcdde_lang = "";
const _sfc_main$1 = {
  el: "#sub_order",
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({
    id: "sub_order",
    class: "w-sto"
  }, _attrs))} data-v-78cfcdde>`);
  if ($props.items.length) {
    _push(ssrRenderComponent(_component_RouterLink, { to: "/checkout" }, {
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`<button class="w-sto" data-v-78cfcdde${_scopeId}><div class="fon_btn" data-v-78cfcdde${_scopeId}></div>Оплатить онлайн</button>`);
        } else {
          return [
            createVNode("button", {
    ...
    _push(ssrRenderComponent(_component_RouterLink, { to: "/catalog" }, {
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`<button class="w-sto" data-v-78cfcdde${_scopeId}><div class="fon_btn" data-v-78cfcdde${_scopeId}></div> Добавить товар</button>`);
        } else {
          return [
...
const Submit_order = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-78cfcdde"]]);
const checkout_vue_vue_type_style_index_0_lang = "";
const account_css_vue_type_style_index_1_src_21d58229_scoped_21d58229_lang = "";
const _sfc_main = {
  el: "#checkout",
  components: {
    BasketInfo,
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "sot-ob" }, _attrs))} data-v-21d58229><div class="wrapper flex" data-v-21d58229><div class="user_card flex auto" data-v-21d58229><div class="interactiv user_card_div auto" id="checkout" data-v-21d58229><div class="w-sto kor" id="kor" data-v-21d58229><p class="small-big VAG" data-v-21d58229>Оформление</p><div class="w-sto flex kor_block jus-sp" data-v-21d58229><div style="${ssrRenderStyle({ "width": "50%", "padding-top": "20px", "padding-left": "2%" })}" data-v-21d58229>`);
  _push(ssrRenderComponent(_component_client_only, null, {}, _parent));
  _push(`<p align="left" class="VAG small" data-v-21d58229>Товары</p>`);
  _push(ssrRenderComponent(_component_order_product_list, {
    orderList: _ctx.$store.getUser.basket
  }, null, _parent));
  _push(`</div><div style="${ssrRenderStyle({ "width": "40%" })}" class="register_zakaz" data-v-21d58229>`);
...
const checkout = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-21d58229"]]);
export {
  checkout as default
};
//# sourceMappingURL=checkout-68ccdac1.js.map
