import { _ as _export_sfc, e as __nuxt_component_0, b as __nuxt_component_0$1 } from "../server.mjs";
...
const hexTovar_css_vue_type_style_index_0_src_dd595d79_scoped_dd595d79_lang = "";
const _sfc_main$4 = {
  el: "#photo-album",
...
const TovarMinImageList = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["ssrRender", _sfc_ssrRender$4], ["__scopeId", "data-v-dd595d79"]]);
...
const katalog_scss_vue_type_style_index_0_src_179cdffb_scoped_179cdffb_lang = "";
const checkbox_scss_vue_type_style_index_1_src_179cdffb_scoped_179cdffb_lang = "";
const CatalogProduct_vue_vue_type_style_index_2_scoped_179cdffb_lang = "";
const _sfc_main = {
  el: "#product_catalog",
  name: "CatalogProduct",
  props: ["pr"],
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<section${ssrRenderAttrs(mergeProps({
    class: "product",
    id: "product_catalog"
  }, _attrs))} data-v-179cdffb><div class="product__photo" data-v-179cdffb><div class="photo-container" data-v-179cdffb><div class="photo-main" data-v-179cdffb><div class="controls" data-v-179cdffb></div><img${ssrRenderAttr("src", _ctx.$api_root + $props.pr.image.slice(1))} alt="green apple slice" data-v-179cdffb></div>`);
  _push(ssrRenderComponent(_component_TovarMinImageList, {
    image: $props.pr.image,
    ImageProductList: $props.pr.ImageProductList
  }, null, _parent));
  _push(`</div></div><div class="product__info" data-v-179cdffb><div class="title" data-v-179cdffb>`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<p class="small-big product__name" data-v-179cdffb${_scopeId}>${ssrInterpolate($props.pr.name)}</p>`);
      } else {
        return [
  ...
  _push(`<span class="very-small product__code" data-v-179cdffb>COD: ${ssrInterpolate($props.pr.id)}</span></div><div class="price" data-v-179cdffb><span class="product__price small-big" data-v-179cdffb>${ssrInterpolate(_ctx.select_productItem.price)} <span class="product__price small" data-v-179cdffb>${ssrInterpolate($props.pr.price_currency)}</span></span></div>`);
  ...
  _push(`<div style="${ssrRenderStyle(_ctx.select_productItem.weight ? "margin-top: 8px" : "margin-top: 56px")}" class="flex jus-sp" data-v-179cdffb>`);
...
const CatalogProduct = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-179cdffb"]]);
export {
  CatalogProduct as C,
  RatingComp as R,
...
//# sourceMappingURL=CatalogProduct-01554aae.js.map
