...
const account_css_vue_type_style_index_0_src_4e27485a_scoped_4e27485a_lang = "";
const _sfc_main$1 = {
  el: "#pr_list_info",
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  }, _attrs))} data-v-4e27485a><p class="m2" data-v-4e27485a>Товаров: ${ssrInterpolate($options.getCountBasket())}</p><p class="m2" data-v-4e27485a>Вес: ${ssrInterpolate($options.getWeight())}</p><p class="m2" data-v-4e27485a> Цена: ${ssrInterpolate($props.items.reduce(function(sum, elem) {
    return sum + parseFloat(elem.productItem.price);
  }, 0))}</p>`);
  if ($props.ordered) {
    _push(`<p class="m2" data-v-4e27485a>Цена доставки: ${ssrInterpolate($props.delivery_price ? $props.delivery_price : "Не выбранно")}</p>`);
  } else {
    _push(`<!---->`);
  }
  _push(`<p class="m2" data-v-4e27485a>скидки:</p><ul data-v-4e27485a><li data-v-4e27485a>*в разработке*</li></ul><p id="is" class="small" data-v-4e27485a> Итоговая сумма: ${ssrInterpolate($options.getSumm())}</p></div>`);
}
...
const ProductListInfo = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-4e27485a"]]);
...
//# sourceMappingURL=BasketInfo-c3e99e9d.js.map
