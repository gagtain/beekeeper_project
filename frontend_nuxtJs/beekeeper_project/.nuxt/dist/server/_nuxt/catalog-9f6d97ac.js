...
const katalog_scss_vue_type_style_index_0_src_24476f5d_scoped_24476f5d_lang = "";
const checkbox_scss_vue_type_style_index_1_src_24476f5d_scoped_24476f5d_lang = "";
const hexTovar_css_vue_type_style_index_2_src_true_lang = "";
const catalog_vue_vue_type_style_index_3_scoped_24476f5d_lang = "";
const _sfc_main = {
  el: "#catalog",
  name: "CatalogItem",
  components: {
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ id: "catalog" }, _attrs))} data-v-24476f5d><div class="absolute flex w-sto h_sto" style="${ssrRenderStyle({ "pointer-events": "none" })}" data-v-24476f5d><dialog id="dialog" class="absolute auto" style="${ssrRenderStyle({ "pointer-events": "auto" })}" data-v-24476f5d>`);
  ...
  _push(`<button class="btn w-sto btn-green" onclick="window.dialog.close();" data-v-24476f5d>Показать</button><button onclick="window.dialog.close();" aria-label="close" class="x" data-v-24476f5d> ❌ </button></dialog></div><div class="sot-ob" data-v-24476f5d><div class="wrapper-product w-sto flex" data-v-24476f5d><div class="interactiv auto back" data-v-24476f5d>`);
  if (_ctx.$route.query.filter) {
    _push(`<p style="${ssrRenderStyle({ "margin-left": "5%" })}" class="small" data-v-24476f5d>${ssrInterpolate(JSON.parse(_ctx.$route.query.filter).name)}</p>`);
  } else {
    _push(`<!---->`);
  }
  _push(`<div class="flex w-sto product_div" data-v-24476f5d><div class="block filter_div" data-v-24476f5d><div class="filter-product" id="filter_desk" data-v-24476f5d>`);
  _push(ssrRenderComponent(_component_FilterCatalog, {
    category_list: $data.category_list,
    catalog_list: $data.catalog_list
  }, null, _parent));
  _push(`</div></div><div class="product_osnov relative" data-v-24476f5d><div class="sorted_div flex jus-sp" data-v-24476f5d>`);
  _push(ssrRenderComponent(_component_SortedCatalog, { catalog_list: $data.catalog_list }, null, _parent));
  _push(`<div class="mob_filter flex" data-v-24476f5d><img onclick="window.dialog.showModal();" class="open_filter_mob auto"${ssrRenderAttr("src", _imports_0)} alt="" data-v-24476f5d></div></div>`);
  if ($data.catalog_list.length) {
    _push(`<div class="w-sto product-list flex" data-v-24476f5d><!--[-->`);
    ...
    _push(`<div style="${ssrRenderStyle({ "width": "50%", "margin": "auto", "margin-top": "10%" })}" data-v-24476f5d><div style="${ssrRenderStyle({ "text-align": "center" })}" class="flex w-sto" data-v-24476f5d><p style="${ssrRenderStyle({ "font-size": "28px" })}" class="VAG auto" data-v-24476f5d>Товаров с выбранными параметрами нету :(</p></div><div class="select_size" data-v-24476f5d>`);
    _push(ssrRenderComponent(_component_NuxtLink, { to: "/catalog" }, {
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`<button style="${ssrRenderStyle({ "background": "rgb(255, 188, 65)", "cursor": "pointer", "width": "100%", "border": "medium none", "border-radius": "6px", "font-size": "26px", "padding": "2%", "margin-top": "1%" })}" data-v-24476f5d${_scopeId}> Сбросить настройки </button>`);
        } else {
          return [
            createVNode("button", {
...
const catalog = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-24476f5d"]]);
export {
  catalog as default
};
//# sourceMappingURL=catalog-9f6d97ac.js.map
