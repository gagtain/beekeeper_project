import { _ as _export_sfc, b as api_root, u as useHead, d as __nuxt_component_0 } from "../server.mjs";
import { mergeProps, useSSRContext, reactive, resolveComponent, withCtx, createVNode, createTextVNode } from "vue";
import "vue-router";
import { B as BasketInfo, P as ProductListInfo } from "./BasketInfo-7bc07d4e.js";
...
const checkbox_scss_vue_type_style_index_0_src_0de29960_scoped_0de29960_lang = "";
const Checkout_vue_vue_type_style_index_1_scoped_0de29960_lang = "";
const Checkout_vue_vue_type_style_index_2_scoped_0de29960_lang = "";
const _sfc_main$2 = {
  components: { SDEKcart },
  el: "#check_form",
  data() {
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ id: "check_form" }, _attrs))} data-v-0de29960><p class="VAG" align="left" data-v-0de29960>Доставка</p><div class="relative" data-v-0de29960>`);
  if ($data.user_default_number) {
    _push(`<input disabled type="text"${ssrRenderAttr("value", $data.user_default_field_number)} data-v-0de29960>`);
  } else {
    _push(`<div data-v-0de29960>`);
    if (!$data.user_number_val) {
      _push(`<p style="${ssrRenderStyle({ "color": "brown" })}" data-v-0de29960>Неверно указан номер, пример: 79111111111</p>`);
    } else {
      _push(`<!---->`);
    }
    _push(`<input type="text"${ssrRenderAttr("value", $data.user_number)} data-v-0de29960></div>`);
  }
  _push(`<span class="floating-label active" data-v-0de29960>Номер телефона</span></div>`);
  if ($data.user_default_number) {
    _push(`<button style="${ssrRenderStyle({ "background": "rgb(76, 175, 80)", "cursor": "pointer", "width": "100%", "border": "medium none", "border-radius": "6px", "font-size": "16px", "padding": "2%" })}" data-v-0de29960> Изменить телефон </button>`);
  } else {
    _push(`<!---->`);
  }
  _push(`<div class="h_sto" data-v-0de29960>`);
  if ($data.delivery_info) {
    _push(`<div data-v-0de29960><div class="relative" data-v-0de29960><input type="text" disabled${ssrRenderAttr("value", $data.delivery_info.price)} data-v-0de29960><span class="floating-label active" data-v-0de29960>Цена</span></div><div class="relative" data-v-0de29960><input type="text" disabled${ssrRenderAttr("value", $data.delivery_info.id)} data-v-0de29960><span class="floating-label active" data-v-0de29960>Номер постмата</span></div><div class="relative" data-v-0de29960><input type="text" disabled${ssrRenderAttr("value", $data.delivery_info.PVZ.Address)} data-v-0de29960><span class="floating-label active" data-v-0de29960>Адрес</span></div><div class="relative" data-v-0de29960><input type="text" disabled${ssrRenderAttr("value", $data.delivery_info.term)} data-v-0de29960><span class="floating-label active" data-v-0de29960>Примерное время доставки</span></div></div>`);
  } else {
    _push(`<!---->`);
  }
  _push(`</div>`);
...
const Checkouts = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender$2], ["__scopeId", "data-v-0de29960"]]);
...
async function addOrder(delivery_price, order_id) {
  try {
    var response = await axios({
...
const account_css_vue_type_style_index_0_src_2f5b4428_scoped_2f5b4428_lang = "";
const _sfc_main$1 = {
  el: "#sub_order",
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({
    id: "sub_order",
    class: "w-sto"
  }, _attrs))} data-v-2f5b4428>`);
  if ($props.items.length) {
    _push(ssrRenderComponent(_component_RouterLink, { to: "/checkout" }, {
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`<button class="w-sto" data-v-2f5b4428${_scopeId}><div class="fon_btn" data-v-2f5b4428${_scopeId}></div>Оплатить онлайн</button>`);
        } else {
          return [
            createVNode("button", {
    ...
    _push(ssrRenderComponent(_component_RouterLink, { to: "/catalog" }, {
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`<button class="w-sto" data-v-2f5b4428${_scopeId}><div class="fon_btn" data-v-2f5b4428${_scopeId}></div> Добавить товар</button>`);
        } else {
          return [
...
const Submit_order = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-2f5b4428"]]);
...
const account_css_vue_type_style_index_1_src_8d1f6bbf_scoped_8d1f6bbf_lang = "";
const _sfc_main = {
  el: "#checkout",
  components: {
    BasketInfo,
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "sot-ob" }, _attrs))} data-v-8d1f6bbf><div class="wrapper flex" data-v-8d1f6bbf><div class="user_card flex auto" data-v-8d1f6bbf><div class="interactiv user_card_div auto" id="checkout" data-v-8d1f6bbf><div class="w-sto kor" id="kor" data-v-8d1f6bbf><p class="small-big VAG" data-v-8d1f6bbf>Оформление</p>`);
  if ($data.order) {
    _push(`<div class="w-sto flex kor_block jus-sp" data-v-8d1f6bbf><div class="w-sto-1000px checkout" data-v-8d1f6bbf>`);
    _push(ssrRenderComponent(_component_client_only, null, {}, _parent));
    _push(`<p align="left" class="VAG small" data-v-8d1f6bbf>Товары</p>`);
    _push(ssrRenderComponent(_component_order_product_list, {
      orderList: $data.order.product_list_transaction
    }, null, _parent));
    _push(`</div><div class="w-sto-1000px register_zakaz" data-v-8d1f6bbf>`);
...
const checkout = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-8d1f6bbf"]]);
export {
  checkout as default
};
//# sourceMappingURL=checkout-6c28eff2.js.map
