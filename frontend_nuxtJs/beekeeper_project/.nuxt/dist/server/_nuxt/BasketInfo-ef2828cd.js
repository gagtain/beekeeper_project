...
const account_css_vue_type_style_index_0_src_eeedbb6d_scoped_eeedbb6d_lang = "";
const _sfc_main$1 = {
  el: "#pr_list_info",
  props: ["items"],
  data() {
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  }, _attrs))} data-v-eeedbb6d><p class="m2" data-v-eeedbb6d>Товаров: ${ssrInterpolate($options.getCountBasket())}</p><p class="m2" data-v-eeedbb6d>Вес: ${ssrInterpolate($options.getWeight())}</p><p class="m2" data-v-eeedbb6d> Цена: ${ssrInterpolate($props.items.reduce(function(sum, elem) {
    return sum + parseFloat(elem.productItem.product.price);
  }, 0))}</p><p class="m2" data-v-eeedbb6d>скидки:</p><ul data-v-eeedbb6d><li data-v-eeedbb6d>*в разработке*</li></ul><p id="is" class="small" data-v-eeedbb6d> Итоговая сумма: ${ssrInterpolate($options.getSumm())}</p></div>`);
}
...
const ProductListInfo = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-eeedbb6d"]]);
...
//# sourceMappingURL=BasketInfo-ef2828cd.js.map
