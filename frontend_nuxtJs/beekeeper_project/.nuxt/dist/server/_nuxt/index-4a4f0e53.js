...
import { A as AddBasket, F as FavoriteComp } from "./FavoriteComp-e87b76fb.js";
import { C as CatalogProduct, T as TovarMinImageList, R as RatingComp, S as SelectVariantMenu } from "./CatalogProduct-f2602567.js";
...
import "ohash";
import "defu";
const main_css_vue_type_style_index_0_src_a315798f_scoped_a315798f_lang = "";
const hexTovar_css_vue_type_style_index_1_src_a315798f_scoped_a315798f_lang = "";
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<section${ssrRenderAttrs(mergeProps({
    class: "product",
    id: "product_catalog"
  }, _attrs))} data-v-a315798f><div class="product__photo" data-v-a315798f><div class="photo-container" data-v-a315798f><div class="photo-main" data-v-a315798f><div class="controls" data-v-a315798f></div><img${ssrRenderAttr("src", _ctx.$api_root + $props.pr.image)} alt="green apple slice" data-v-a315798f></div>`);
  _push(ssrRenderComponent(_component_TovarMinImageList, {
    image: $props.pr.image,
    ImageProductList: $props.pr.ImageProductList
  }, null, _parent));
  _push(`</div></div><div class="product__info" data-v-a315798f><div class="title" data-v-a315798f>`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<p class="small-big product__name" data-v-a315798f${_scopeId}>${ssrInterpolate($props.pr.name)}</p>`);
      } else {
        return [
  ...
  _push(`<span class="very-small product__code" data-v-a315798f>COD: ${ssrInterpolate($props.pr.id)}</span></div>`);
  _push(ssrRenderComponent(_component_rating_comp, {
    rating: $props.pr.rating
  }, null, _parent));
  _push(`<div class="price" data-v-a315798f><span class="product__price small-big" data-v-a315798f>${ssrInterpolate(_ctx.select_productItem.price)} <span class="product__price small" data-v-a315798f>${ssrInterpolate($props.pr.price_currency)}</span></span></div>`);
  ...
  _push(`<div class="product__text" data-v-a315798f><p class="small" data-v-a315798f>${ssrInterpolate($props.pr.description.slice(15))}...</p></div><div style="${ssrRenderStyle(_ctx.select_productItem.weight ? "margin-top: 8px" : "margin-top: 56px")}" class="flex" data-v-a315798f>`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender$2], ["__scopeId", "data-v-a315798f"]]);
...
//# sourceMappingURL=index-4a4f0e53.js.map
