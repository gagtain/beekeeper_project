...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  }, _attrs))} data-v-c784a72c><p class="m2" data-v-c784a72c>\u0422\u043E\u0432\u0430\u0440\u043E\u0432: ${ssrInterpolate($options.getCountBasket())}</p><p class="m2" data-v-c784a72c>\u0412\u0435\u0441: ${ssrInterpolate($options.getWeight())}</p><p class="m2" data-v-c784a72c> \u0426\u0435\u043D\u0430: ${ssrInterpolate($props.ordered ? $props.order_amount : $props.items.reduce(function(sum, elem) {
    return sum + parseFloat(elem.productItem.price);
  }, 0))}</p>`);
  if ($props.ordered) {
    _push(`<p class="m2" data-v-c784a72c>\u0426\u0435\u043D\u0430 \u0434\u043E\u0441\u0442\u0430\u0432\u043A\u0438: ${ssrInterpolate($props.delivery_price != null ? $props.delivery_price : "\u041D\u0435 \u0432\u044B\u0431\u0440\u0430\u043D\u043D\u043E")}</p>`);
  } else {
    _push(`<!---->`);
  }
  _push(`<p class="m2" data-v-c784a72c>\u0441\u043A\u0438\u0434\u043A\u0438:</p><ul data-v-c784a72c><li data-v-c784a72c>${ssrInterpolate($options.getSale())}</li></ul><p id="is" class="small" data-v-c784a72c> \u0418\u0442\u043E\u0433\u043E\u0432\u0430\u044F \u0441\u0443\u043C\u043C\u0430: ${ssrInterpolate($options.getSumm())}</p></div>`);
}
...
const ProductListInfo = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-c784a72c"]]);
const _sfc_main = {
...
//# sourceMappingURL=BasketInfo-11720090.mjs.map
