...
import { C as CatalogProduct, T as TovarMinImageList, R as RatingComp, S as SelectVariantMenu } from './CatalogProduct-a72e80dd.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  ssrRenderList($data.news, (new_obj) => {
    _push(`<article class="grid-item"><div class="image"><img${ssrRenderAttr("src", this.$api_root + new_obj.main_image.slice(1))}></div><div class="info">`);
    _push(ssrRenderComponent(_component_NuxtLink, {
      "no-prefetch": "",
      to: `/news/${new_obj.id}`
    }, {
...
//# sourceMappingURL=index-b225b980.mjs.map
