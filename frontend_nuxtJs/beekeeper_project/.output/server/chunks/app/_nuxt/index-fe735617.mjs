...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ style: { "padding-top": "50px" } }, _attrs))} data-v-52e1c764><div class="wrapper" data-v-52e1c764>`);
  _push(ssrRenderComponent(_component_nuxt_img, {
    format: "webp",
    rel: "preconnect",
  ...
  _push(`<div class="${ssrRenderClass([$data.wrapper_active ? "actives" : "", "absolute main-nak"])}" data-v-52e1c764></div><div class="main relative" data-v-52e1c764><div class="interactiv flex" data-v-52e1c764><div class="main_center auto" data-v-52e1c764><div class="main_text_div auto" data-v-52e1c764><p class="main_text" data-v-52e1c764>${ssrInterpolate($options.get_obj_text("1", "text"))}</p><div class="bt flex m2" data-v-52e1c764><button style="${ssrRenderStyle(_ctx.$device.isDesktop ? "width: 45%; margin: 0;" : "")}" class="main_bt" data-v-52e1c764><div class="flex sto" data-v-52e1c764><p class="main_bt_p" data-v-52e1c764>\u041F\u043E\u043F\u0440\u043E\u0431\u043E\u0432\u0430\u0442\u044C!</p></div></button>`);
  if (_ctx.$device.isDesktop) {
    _push(`<a href="#advantages" style="${ssrRenderStyle({ "margin": "0", "margin-left": "8px", "width": "45%" })}" class="main_bt" data-v-52e1c764><div class="flex sto" data-v-52e1c764><p class="main_bt_p" data-v-52e1c764>\u041F\u043E\u0441\u043C\u043E\u0442\u0440\u0435\u0442\u044C!</p></div></a>`);
  } else {
    _push(`<!---->`);
  }
  _push(`</div></div>`);
  if (!_ctx.$device.isMobileOrTablet) {
    _push(`<div class="main_img_div" data-v-52e1c764><img${ssrRenderAttr("src", `${_ctx.$api_root}static/online_store/images/phel.png`)} class="phel" alt="" data-v-52e1c764><div class="slider-produtos-wrap h_sto" data-v-52e1c764>`);
    _push(ssrRenderComponent(_component_swiper, {
      slidesPerView: 1,
      spaceBetween: 500,
      autoplay: {
      ...
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(ssrRenderComponent(_component_swiper_slide, null, {
            default: withCtx((_2, _push3, _parent3, _scopeId2) => {
              if (_push3) {
                _push3(`<img${ssrRenderAttr("src", `${_ctx.$api_root.slice(0, -1)}${$options.get_obj_text("1", "image")}`)} class="main_img" width="100%" height="100%" alt="" data-v-52e1c764${_scopeId2}>`);
              } else {
                return [
                  createVNode("img", {
                    src: `${_ctx.$api_root.slice(0, -1)}${$options.get_obj_text("1", "image")}`,
                    class: "main_img",
                    width: "100%",
                    height: "100%",
                    alt: ""
    ...
    _push(`<div data-v-52e1c764><div style="${ssrRenderStyle({ "display": "block" })}" class="" data-v-52e1c764><div class="flex w-sto jus-sp info_kart_div" data-v-52e1c764><div class="w-sto flex" data-v-52e1c764><div class="w-sto auto auto" data-v-52e1c764>`);
    _push(ssrRenderComponent(_component_Advantages_slider, null, null, _parent));
    _push(`</div></div></div></div></div>`);
  }
  _push(`</div></div></div></div><div class="sot" data-v-52e1c764><div class="interactiv auto" data-v-52e1c764><div class="flex w-sto text_in_sot" data-v-52e1c764><p class="big auto main-text" data-v-52e1c764>\u041F\u043E\u043F\u0443\u043B\u044F\u0440\u043D\u044B\u0435 \u0442\u043E\u0432\u0430\u0440\u044B</p></div><div class="block_info sliders big-block" data-v-52e1c764><div class="slider-produtos-wrap" data-v-52e1c764>`);
  if ($data.popular_product != null) {
        ...
        if (_push2) {
          ...
          ssrRenderList($data.popular_product, (pop_product) => {
            _push2(ssrRenderComponent(_component_swiper_slide, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="hex slide auto" data-v-52e1c764${_scopeId2}>`);
    ...
    _push(`<div class="w-sto h_sto" data-v-52e1c764>`);
    _push(ssrRenderComponent(_component_LoadingComp, null, null, _parent));
    _push(`</div>`);
  }
  _push(`</div></div>`);
  if (_ctx.$device.isDesktop) {
    _push(`<div class="flex w-sto text_in_sot relative" data-v-52e1c764><div id="advantages" class="absolute" style="${ssrRenderStyle({ "top": "-80%" })}" data-v-52e1c764></div><p class="big auto main-text" data-v-52e1c764>\u041D\u0430\u0448\u0438 \u043F\u0440\u0435\u0438\u043C\u0443\u0449\u0435\u0441\u0442\u0432\u0430</p></div>`);
  } else {
    _push(`<!---->`);
  }
  if (_ctx.$device.isDesktop) {
    _push(`<div style="${ssrRenderStyle({ "display": "block" })}" class="block_info" data-v-52e1c764><div class="flex w-sto jus-sp info_kart_div" data-v-52e1c764><div class="w-sto flex" data-v-52e1c764><div class="w-sto auto auto" data-v-52e1c764>`);
  ...
  _push(ssrRenderComponent(_component_to_scroll, { id: "eco" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div style="${ssrRenderStyle({ "display": "block" })}" class="block_info" data-v-52e1c764${_scopeId}><div class="flex w-sto jus-sp info_kart_div" data-v-52e1c764${_scopeId}><div class="kart" data-v-52e1c764${_scopeId}><div class="w-sto h_sto" data-v-52e1c764${_scopeId}>`);
        ...
        _push2(`</div></div><div class="dostav_info flex" data-v-52e1c764${_scopeId}><div class="w-sto auto" data-v-52e1c764${_scopeId}><p class="small-big VAG" style="${ssrRenderStyle({ "line-height": "1" })}" data-v-52e1c764${_scopeId}>${ssrInterpolate($options.get_obj_text("3", "title"))}</p><p class="small m2" data-v-52e1c764${_scopeId}>${ssrInterpolate($options.get_obj_text("3", "text"))}</p></div></div></div></div>`);
      } else {
        return [
          createVNode("div", {
            style: { "display": "block" },
  ...
  _push(ssrRenderComponent(_component_to_scroll, { id: "news" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="interactiv auto" data-v-52e1c764${_scopeId}><div class="flex w-sto text_in_sot" data-v-52e1c764${_scopeId}><p class="big auto main-text" data-v-52e1c764${_scopeId}>\u041D\u043E\u0432\u043E\u0441\u0442\u0438</p></div><section style="${ssrRenderStyle({ "padding": "5%" })}" class="auto grid" data-v-52e1c764${_scopeId}><!--[-->`);
        ssrRenderList($data.news, (new_obj) => {
          _push2(`<article class="grid-item" data-v-52e1c764${_scopeId}><div class="image" data-v-52e1c764${_scopeId}><img${ssrRenderAttr("src", this.$api_root + new_obj.main_image.slice(1))} data-v-52e1c764${_scopeId}></div><div class="info" data-v-52e1c764${_scopeId}>`);
          _push2(ssrRenderComponent(_component_NuxtLink, {
            ...
            default: withCtx((_2, _push3, _parent3, _scopeId2) => {
              if (_push3) {
                _push3(`<h2 class="VAG" data-v-52e1c764${_scopeId2}>${ssrInterpolate(new_obj.title)}</h2>`);
              } else {
                return [
          ...
          _push2(`<div class="info-text" data-v-52e1c764${_scopeId}><p data-v-52e1c764${_scopeId}>${ssrInterpolate(new_obj.main_text.slice(40))}...</p></div><div class="button-wrap" data-v-52e1c764${_scopeId}>`);
          _push2(ssrRenderComponent(_component_NuxtLink, {
            "no-prefetch": "",
            class: "atuin-btn",
            to: `/news/${new_obj.id}`
        ...
        _push2(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<button style="${ssrRenderStyle({ "background": "rgb(160,166,62)", "cursor": "pointer", "width": "100%", "border": "none", "border-radius": "6px", "padding": "2% 3%" })}" data-v-52e1c764${_scopeId2}><div class="w-sto h_sto flex" data-v-52e1c764${_scopeId2}><p class="auto small-big" data-v-52e1c764${_scopeId2}>\u0412\u0441\u0435 \u043D\u043E\u0432\u043E\u0441\u0442\u0438</p></div></button>`);
            } else {
              return [
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        if (!_ctx.$store.getUser.is_sending) {
          _push2(`<div class="interactiv auto" data-v-52e1c764${_scopeId}><div class="flex w-sto text_in_sot" data-v-52e1c764${_scopeId}><p class="big auto main-text" data-v-52e1c764${_scopeId}>\u0420\u0430\u0441\u0441\u044B\u043B\u043A\u0430</p></div>`);
  ...
  _push(ssrRenderComponent(_component_to_scroll, { id: "ref" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="ref-block w-sto" data-v-52e1c764${_scopeId}><div class="flex w-sto text_in_sot" data-v-52e1c764${_scopeId}><p class="big auto main-text" style="${ssrRenderStyle({ "color": "rgb(241, 195, 96)", "text-shadow": "10px 10px 10px black", "padding": "1%" })}" data-v-52e1c764${_scopeId}>\u041E \u043D\u0430\u0448\u0435\u043C \u0442\u043E\u0432\u0430\u0440\u0435</p></div><div class="interactiv auto h-sto flex" data-v-52e1c764${_scopeId}><div class="block_info o_product auto" data-v-52e1c764${_scopeId}><div class="predp" data-v-52e1c764${_scopeId}><div class="predp-img auto" data-v-52e1c764${_scopeId}><img width="100%" height="100%"${ssrRenderAttr("src", _ctx.$api_root.slice(0, -1) + $options.get_obj_text("4", "image"))} alt="" data-v-52e1c764${_scopeId}></div><p class="small-big predp-name" data-v-52e1c764${_scopeId}>${ssrInterpolate($options.get_obj_text("4", "director"))}</p><p class="small" data-v-52e1c764${_scopeId}>\u0414\u0438\u0440\u0435\u043A\u0442\u043E\u0440 \u043A\u043E\u043C\u043F\u0430\u043D\u0438\u0438 </p></div><div class="predp-text flex" data-v-52e1c764${_scopeId}><p class="small-big" data-v-52e1c764${_scopeId}>${ssrInterpolate($options.get_obj_text("4", "text"))}</p></div></div></div><div class="interactiv" data-v-52e1c764${_scopeId}></div></div>`);
      } else {
        return [
            ...
            createVNode("div", { class: "interactiv auto h-sto flex" }, [
              createVNode("div", { class: "block_info o_product auto" }, [
                ...
                createVNode("div", { class: "predp-text flex" }, [
                  createVNode("p", { class: "small-big" }, toDisplayString($options.get_obj_text("4", "text")), 1)
                ])
              ])
            ]),
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-52e1c764"]]);

export { index as default };
//# sourceMappingURL=index-fe735617.mjs.map
