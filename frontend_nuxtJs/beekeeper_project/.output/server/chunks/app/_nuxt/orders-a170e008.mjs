...
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderStyle, ssrRenderList, ssrRenderClass, ssrInterpolate, ssrRenderSlot, ssrRenderAttr } from 'vue/server-renderer';
import { L as LoadingComp } from './LoadingComp-34c86e82.mjs';
import { O as OrderProductList } from './OrderProductList-48bace03.mjs';
import 'ofetch';
import 'hookable';
import 'unctx';
import 'destr';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "sot-ob" }, _attrs))} data-v-78f93967><div class="wrapper flex" data-v-78f93967>`);
        ...
        if ($data.rating_list) {
          _push2(ssrRenderComponent(_component_OrderProductList, { orderList: $data.rating_list_obj }, {
            default: withCtx((slotProps, _push3, _parent3, _scopeId2) => {
              if (_push3) {
                _push3(`<button style="${ssrRenderStyle({ "background": "rgb(76, 175, 80)", "cursor": "pointer", "width": "100%", "border": "medium none", "border-radius": "6px", "font-size": "16px", "padding": "2%", "margin-top": "1%" })}" data-v-78f93967${_scopeId2}> \u0412\u044B\u0431\u0440\u0430\u0442\u044C </button>`);
              } else {
                return [
                  createVNode("button", {
          ...
          _push2(`<div data-v-78f93967${_scopeId}><div class="flex" data-v-78f93967${_scopeId}>`);
          ...
          _push2(`</div><p class="VAG" align="center" data-v-78f93967${_scopeId}>\u0412\u0430\u0448 \u043E\u0442\u0437\u044B\u0432</p></div>`);
        }
      } else {
        return [
  ...
  _push(`<div class="user_card flex auto" data-v-78f93967><div class="interactiv user_card_div auto" id="orders_main" data-v-78f93967><div class="kor w-sto relative" data-v-78f93967><p class="small-big VAG" data-v-78f93967>\u0417\u0430\u043A\u0430\u0437\u044B</p><div class="w-sto h_sto" data-v-78f93967>`);
  if (!$data.list_order[0].loading) {
    _push(`<div class="product_order_list" data-v-78f93967><!--[-->`);
    ssrRenderList($data.list_order, (order) => {
      _push(`<div class="order m-2" data-v-78f93967><div class="${ssrRenderClass(order.status == "\u0417\u0430\u043A\u0440\u044B\u0442\u044B\u0439" ? "not-active" : "")}" data-v-78f93967><div class="flex w-sto jus-sp" data-v-78f93967><p align="left" data-v-78f93967>\u0417\u0430\u043A\u0430\u0437 \u043D\u043E\u043C\u0435\u0440 ${ssrInterpolate(order.id)}</p><div class="select_size" data-v-78f93967><button style="${ssrRenderStyle({ "background": "rgb(76, 175, 80)", "cursor": "pointer", "width": "100%", "border": "medium none", "border-radius": "6px", "font-size": "16px", "padding": "2%", "margin-top": "1%" })}" data-v-78f93967> \u041E\u0441\u0442\u0430\u0432\u0438\u0442\u044C \u043E\u0442\u0437\u044B\u0432 </button></div></div><div class="order_warp w-sto h_sto flex jus-sp" data-v-78f93967><div class="product_order m-2" data-v-78f93967>`);
      _push(ssrRenderComponent(_component_order_product_list, {
        orderList: order.product_list_transaction
      }, null, _parent));
      _push(`</div><div class="order_description" data-v-78f93967><div class="flex w-sto m-2" data-v-78f93967><div class="w-50" data-v-78f93967><p data-v-78f93967>\u041A\u043E\u0433\u0434\u0430</p></div><div class="w-50" data-v-78f93967><p data-v-78f93967>${ssrInterpolate($options.getDateFormat(new Date(order.datetime)))}</p></div></div><div class="flex w-sto m-2" data-v-78f93967><div class="w-50" data-v-78f93967><p data-v-78f93967>\u041A\u0443\u0434\u0430</p></div><div class="w-50" data-v-78f93967><p data-v-78f93967>${ssrInterpolate(order.order_address)} ${ssrInterpolate(order.order_index)}</p></div></div><div class="flex w-sto m-2" data-v-78f93967><div class="w-50" data-v-78f93967><p data-v-78f93967>\u0421\u043F\u043E\u0441\u043E\u0431 \u043E\u043F\u043B\u0430\u0442\u044B</p></div><div class="w-50" data-v-78f93967><p data-v-78f93967>\u041E\u043D\u043B\u0430\u0439\u043D ${ssrInterpolate(order.amount)}</p></div></div><div class="flex w-sto m-2" data-v-78f93967><div class="w-50" data-v-78f93967><p data-v-78f93967>\u041F\u043E\u043A\u0443\u043F\u0430\u0442\u0435\u043B\u044C</p></div><div class="w-50" data-v-78f93967><p data-v-78f93967>${ssrInterpolate(order.user.FIO)} ${ssrInterpolate(order.user.email)}</p></div></div><div class="flex w-sto m-2" data-v-78f93967><div class="w-50" data-v-78f93967><p data-v-78f93967>\u041F\u043E\u043B\u0443\u0447\u0430\u0442\u0435\u043B\u044C</p></div><div class="w-50" data-v-78f93967><p data-v-78f93967>${ssrInterpolate(order.user.FIO)} ${ssrInterpolate(order.user.email)}</p></div></div><div class="flex w-sto m-2" data-v-78f93967><div class="w-50" data-v-78f93967><p data-v-78f93967>\u0421\u0442\u043E\u0438\u043C\u043E\u0441\u0442\u0438 \u0434\u043E\u0441\u0442\u0430\u0432\u043A\u0438</p></div><div class="w-50" data-v-78f93967><p data-v-78f93967>* \u0432 \u0440\u0430\u0437\u0440\u0430\u0431\u043E\u0442\u043A\u0435 *</p></div></div>`);
      if (order.delivery != null) {
        _push(`<div class="flex w-sto m-2" data-v-78f93967><div class="w-50" data-v-78f93967><p data-v-78f93967>\u0421\u0442\u0430\u0442\u0443\u0441 \u0434\u043E\u0441\u0442\u0430\u0432\u043A\u0438</p></div><div class="w-50" data-v-78f93967><p data-v-78f93967>${ssrInterpolate(order.delivery.status)}</p></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="flex w-sto m-2" data-v-78f93967><div class="w-50" data-v-78f93967><p data-v-78f93967>\u0421\u0442\u0430\u0442\u0443\u0441 \u043E\u043F\u043B\u0430\u0442\u044B</p></div><div class="w-50" data-v-78f93967><p data-v-78f93967>${ssrInterpolate(order.payment.status)}</p></div></div></div></div><div class="order_menu m-2" data-v-78f93967>`);
      if (order.status == "\u041E\u0434\u043E\u0431\u0440\u0435\u043D") {
        _push(`<button onclick="alert(&#39;\u0412 \u0440\u0430\u0437\u0440\u0430\u0431\u043E\u0442\u043A\u0435&#39;)" style="${ssrRenderStyle({ "background": "yellow", "cursor": "pointer", "width": "100%", "border": "medium none", "border-radius": "6px", "font-size": "16px", "padding": "2%", "margin-top": "1%" })}" data-v-78f93967> \u041E\u0442\u0441\u043B\u0435\u0434\u0438\u0442\u044C </button>`);
      } else {
        _push(`<!---->`);
      }
      if (order.payment.status == "pending" && order.status != "\u0417\u0430\u043A\u0440\u044B\u0442\u044B\u0439") {
        _push(`<div data-v-78f93967><p data-v-78f93967>\u0417\u0430\u043A\u0430\u0437 \u0431\u0443\u0434\u0435\u0442 \u043E\u0442\u043C\u0435\u043D\u0435\u043D \u0447\u0435\u0440\u0435\u0437 30 \u043C\u0438\u043D\u0443\u0442, \u0432 \u0441\u043B\u0443\u0447\u0430\u0435 \u0435\u0441\u043B\u0438 \u043E\u043D \u043D\u0435 \u0431\u0443\u0434\u0435\u0442 \u043E\u043F\u043B\u0430\u0447\u0435\u043D</p><button style="${ssrRenderStyle({ "background": "rgb(76, 175, 80)", "cursor": "pointer", "width": "100%", "border": "medium none", "border-radius": "6px", "font-size": "16px", "padding": "2%", "margin-top": "1%" })}" data-v-78f93967> \u041E\u043F\u043B\u0430\u0442\u0438\u0442\u044C </button></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div>`);
      if (order.status == "\u0417\u0430\u043A\u0440\u044B\u0442\u044B\u0439") {
        _push(`<button style="${ssrRenderStyle({ "background": "rgb(76, 175, 80)", "cursor": "pointer", "width": "100%", "border": "medium none", "border-radius": "6px", "font-size": "16px", "padding": "2%", "margin-top": "1%" })}" data-v-78f93967> \u041F\u043E\u0432\u0442\u043E\u0440\u0438\u0442\u044C \u0437\u0430\u043A\u0430\u0437 </button>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
    ...
    _push(`<div class="w-sto h_sto flex auto" data-v-78f93967><div class="auto" data-v-78f93967><p style="${ssrRenderStyle({ "font-size": "28px" })}" class="VAG" data-v-78f93967>\u0421\u043F\u0438\u0441\u043E\u043A \u0437\u0430\u043A\u0430\u0437\u043E\u0432 \u043F\u0443\u0441\u0442 :(</p><div class="select_size" data-v-78f93967>`);
    _push(ssrRenderComponent(_component_router_link, { to: "/basket" }, {
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`<button style="${ssrRenderStyle({ "background": "rgb(76, 175, 80)", "cursor": "pointer", "width": "100%", "border": "medium none", "border-radius": "6px", "font-size": "26px", "padding": "2%", "margin-top": "1%" })}" data-v-78f93967${_scopeId}> \u041F\u0435\u0440\u0435\u0439\u0442\u0438 \u0432 \u043A\u043E\u0440\u0437\u0438\u043D\u0443 </button>`);
        } else {
          return [
...
const orders = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-78f93967"]]);

export { orders as default };
//# sourceMappingURL=orders-a170e008.mjs.map
