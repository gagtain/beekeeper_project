...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/about_us-9e69cd74.mjs').then((m) => m.default || m)
  },
  {
    name: "basket",
    path: "/basket",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-fe735617.mjs').then((m) => m.default || m)
  },
  {
    name: "login",
    path: "/login",
...
function _sfc_ssrRender$3(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ id: "footer" }, _attrs))}><footer class="flex" id="deks"><div class="interactiv flex jus-sp auto"><div class="foo"><p class="foo_p">КОМПАНИЯ</p>`);
